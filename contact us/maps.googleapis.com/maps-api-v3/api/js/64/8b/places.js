google.maps.__gjsload__('places', function(_) {
        var vqa = function(a) {
            ...
            xqa = function(a, b) {
                return a && isFinite(a) ? mD(Math.round(mD(a, b)), -b) : a
            },
            pD = function(a, b) {
                var c;
                if (c = b) {
                ...
                if (_.Dfa && typeof a === "number" && a != 5 && a != 6) yqa(this, this.Ph);
            ...
            oD = function(a, b) {
                ...
                for (let p = !0; c[0] < n && p; c[0]++) switch (b.charAt(c[0])) {
                    ...
                    case ".":
                        ...
                        break;
                    case "E":
                        if (a.Fh) throw Error('Multiple exponential symbols in pattern "' + b + '"');
                        a.Fh = !0;
                        a.yh = 0;
                        c[0] + 1 < n && b.charAt(c[0] + 1) == "+" && (c[0]++, a.Lh = !0);
                ...
                a.oh = (e >= 0 ? e : h) - f;
                a.Fh && (a.xh = f + a.oh, a.mh == 0 && a.oh == 0 && (a.oh = 1));
                a.sh.push(Math.max(0, k));
                a.Qh = e == 0 || e == h;
                d = c[0] - d;
                a.Hh = qD(a, b, c);
                c[0] < b.length && b.charAt(c[0]) == ";" ? (c[0]++, a.ph != 1 && (a.th = !0), a.Ah = qD(a, b, c), c[0] += d, a.Bh = qD(a, b, c)) : (a.Ah += a.Gh, a.Bh += a.Hh)
            },
            zqa = function(a, b) {
                a.wh = b;
                oD(a, nD.eE);
            ...
            yqa = function(a, b) {
                ...
                try {
                    let d;
                    (d = "en".replace("_", "-")) && d in Aqa && (c.numberingSystem = Aqa[d]);
            ...
            rD = function(a, b) {
                ...
                let d;
                if (isFinite(c)) {
                    if (d = Math.floor(mD(c, -a.mh)), c = Math.floor(c - mD(d, a.mh)), c < 0 || c >= mD(1, a.mh)) d = Math.round(b), c = 0
                } else d = b, c = 0;
                return {
                    VF: d,
                    RK: c
            ...
            sD = function(a, b, c, d) {
                ...
                b = a.nh;
                g && (b = a.nh);
                for (var h = "", k = e; k > 1E20;) h = "0" + h, k = Math.round(mD(k, -1));
                h = k + h;
                const n = nD.hI;
                k = nD.mE.codePointAt(0);
                var p = h.length,
                    r = 0;
                if (e > 0 || c > 0) {
                ...
                f = String(f);
                g = f.split("e+");
                g.length == 2 && (f = String(Cqa(parseFloat(g[0]), a.uh, 1)), f = f.replace(".", ""), f += "0".repeat(parseInt(g[1], 10) - f.length + 1));
            ...
            Dqa = function(a, b, c) {
                c.push(nD.jI);
                b < 0 ? (b = -b, c.push(nD.lE)) : a.Lh && c.push(nD.vI);
                b = "" + b;
                var d = nD.mE;
                for (let e = b.length; e <
                    a.yh; e++) c.push(d);
                a = d.codePointAt(0) - _.Efa;
                ...
                for (; c[0] < f; c[0]++) {
                    ...
                    if (g == "'") c[0] + 1 < f && b.charAt(c[0] + 1) == "'" ? (c[0]++, d += "'") : e = !e;
                        ...
                        case ";":
                            return d;
                        case "\u00a4":
                            c[0] + 1 < f && b.charAt(c[0] + 1) == "\u00a4" ? (c[0]++, d += a.zh || nD.Ix) : d += wqa(a.zh || nD.Ix);
                            break;
                        case "%":
            ...
            Eqa = function(a, b) {
                a = a.wh == 1 ? tD.cE : tD.fI;
                a == null && (a = tD.cE);
                if (b < 3) return uD;
                b = Math.min(14, b);
                var c = a[mD(1, b)];
                for (--b; !c && b >= 3;) c = a[mD(1, b)], b--;
                if (!c) return uD;
                c = c.other;
                var d = a =
                    "",
            ...
            wD = function(a) {
                ...
                a = nD;
                const b = tD;
                if (Fqa !== a || Gqa !== b) Fqa = a, Gqa = b, Hqa = new pD(1);
                this.rh = Hqa
            },
                ...
                for (let r = 0; r < b.length; r++) {
                    ...
                    switch (b[r].type) {
                        ...
                        case 2:
                            ...
                            var n = e,
                                p = f.Px;
                            h[p] === void 0 ? n.push("Undefined parameter - " + p) : (p = f[h[p]], p === void 0 && (p = f.other), xD(g, p, h, k, n));
                            break;
                        case 0:
                            f = b[r].value;
                            Iqa(a, f, c, _.Ifa, d, e);
                            break;
                        case 1:
                            f = b[r].value, Iqa(a, f, c, _.Gfa, d, e)
                    }
                }
            },
            Iqa = function(a,
                ...
                var g = b.Px,
                    h = b.AE;
                const k = +c[g];
                isNaN(k) ? f.push("Undefined or invalid parameter - " + g) : (h = k - h, g = b[c[g]], g === void 0 && (d = d(Math.abs(h)), g = b[d], g === void 0 && (g = b.other)), b = [], xD(a, g, c, e, b), c = b.join(""), e ? f.push(c) : (a = a.rh.format(h), f.push(c.replace(/#/g, a))))
            },
            Jqa = function(a, b) {
                const c = a.qh,
                    d = (0, _.Ma)(a.ph, a);
                b = b.replace(_.Kfa, function() {
                    c.push("'");
                    return d(c)
                });
                return b = b.replace(_.Jfa, function(e, f) {
                    c.push(f);
                    return d(c)
                })
            },
            ...
            zD = function(a, b) {
                ...
                for (let e = 0; e < b.length; e++) {
                    ...
                    if (0 == b[e].type) f.type = 4, f.value = b[e].value;
                        ...
                        var d = b[e].value;
                        switch (Kqa.test(d) ? 0 : Lqa.test(d) ? 1 : Mqa.test(d) ? 2 : /^\s*\w+\s*/.test(d) ? 3 : 5) {
                            case 2:
                                f.type =
                                    2;
                                f.value = Nqa(a, b[e].value);
                                break;
                            case 0:
                                f.type = 0;
                                f.value = Oqa(a, b[e].value);
                                break;
                            case 1:
                                f.type = 1;
            ...
            Oqa = function(a, b) {
                let c = "",
                    d = 0;
                b = b.replace(Kqa, function(g, h, k) {
                    c = h;
                    k && (d = parseInt(k, 10));
                    return ""
                });
            ...
            CD = function(a) {
                return (b, c) => _.xda(b, c, {
                    get() {
                        return (this.Bk ? ? Rqa ? ? (Rqa = document.createDocumentFragment())).querySelectorAll(a)
                    }
                })
            },
            Sqa = async function(a, b) {
                a.nh || (b = b(await _.Wl("util")), a.nh = a.mh === 5 || a.mh === 9 ? new b.TI : new b.SI);
                return a.nh
            },
            Tqa = function(a, b) {
                return function*() {
            ...
            ED = function(a) {
                return _.hn(_.bn(_.$r))(a)
            },
            Vqa = function(a, b) {
                return _.eg(a, _.pi, 2, Uqa, b)
            },
            Wqa = function(a, b, c) {
                c = c || {};
                c.format = "jspb";
            ...
            Zqa = function() {
                ...
                GD === null && (GD = !1, b.addEventListener("blur", () => {
                    GD = !0
            ...
            JD = function(a) {
                a.Gh && (a.Gh = !1, HD(a), ID(a))
            },
            ID = function(a) {
                const b = a.Qk && a.Gh ? 0 : 1;
                b === 0 && a.Xh !== 0 ? (a.nh.append(a.wh), a.nh.showModal(), a.mh.focus(), a.Xh = 0) : b === 1 && a.Xh !== 1 && (a.nh.close(), a.Bk ? .append(a.wh), KD(a), a.Xh = 1)
            },
            $qa = function(a,
                b = a.ph) {
                b !== -1 && (LD(a, -1), a.mh.value = a.predictions[b].text.text, a.ci.setFormValue(a.mh.value), a.Ql(a.predictions[b]), JD(a), a.mh.focus())
            },
            LD = function(a, b) {
                var c = a.Fh[a.ph];
                ...
                a.ph = b;
                if (c = a.Fh[b]) c.setAttribute("aria-selected", "true"), c.setAttribute("part", "prediction-item prediction-item-selected"), a.mh.setAttribute("aria-activedescendant", c.id),
                    c.appendChild(a.Hh);
                a.ph === -1 ? (a.mh.value = a.Am, a.Ph.appendChild(a.Hh)) : a.mh.value = a.predictions[b].text.text
            },
            ara = function(a) {
            ...
            dra = function(a) {
                ...
                a.mh.addEventListener("blur", b => {
                    b.relatedTarget || FD || GD ? b.relatedTarget && !a.Bk ? .contains(b.relatedTarget) && JD(a) : (a.Qk && a.nh.focus(), KD(a))
                });
            ...
            gra = function(a) {
                a.Gh &&
                    a.Fh.length && (a.mh.setAttribute("aria-controls", a.oh.id), a.oh.style.display = "inline", a.Fh.forEach(a.oh.appendChild, a.oh), a.mh.setAttribute("aria-expanded", "true"), a.qh.style.display = "flex")
            },
            ira = function(a, b) {
                HD(a);
                a.ph = -1;
  ...
  `
            ...
            rra = function(a) {
                ...
                ].filter(_.Fm).slice(0, 2).map(b => BD(b, {
                    VARIANT: "standalone"
                }));
  ...
  `
            ...
            QD = function(a, b) {
                a.gC[Math.min(Math.max(a.mh + b, 0), a.gC.length - 1)].focus()
            },
            RD = function(a) {
                if (a) return a === _.Pt ? !0 : Array.isArray(a) ? a.every(RD) : !1;
                a = typeof a;
            ...
            SD = function(a) {
                a = a.filter(b => !RD(b));
                return a.length ? (0, _.Q)
                `${_.Ur(a,(0,_.Q)`<hr />`)}`: null
            },
            TD = function(...a) {
                return _.Ur(a.filter(b => !RD(b)), (0, _.Q)
            ...
            vra = function(a) {
                return a === null || a === 0 ? null : ura.get(a) || null
            },
            bE = function(a, b) {
                for (const [d, e] of Object.entries(b)) {
                    var c = d;
                    const f = e;
                    if (wra.has(c)) switch (a.Pw.add(c), c) {
                        case "accessibilityOptions":
                            a.uh = f ? new UD(f) : null;
                            break;
                        case "addressComponents":
                            a.oh = f.map(g => new xra(g));
                            break;
                        case "attributions":
                            a.xh = f.map(g => new yra(g));
                            break;
                        case "consumerAlert":
                            a.zh =
                                f ? new zra(f) : null;
                        ...
                        case "fuelOptions":
                            ...
                            a.Gh = f ? new Bra(f, c) : null;
                            break;
                        case "neighborhoodSummary":
                            a.Nh = f ? new Cra(f, g => a.Au({
                                id: g.id
                            })) : null;
                            break;
                        case "generativeSummary":
                            a.Hh = f ? new Dra(f) : null;
                            break;
                        case "googleMapsLinks":
                            a.Lh = f ? new Era(f) : null;
                            break;
                        case "id":
                            Fra(a, f);
                            break;
                        ...
                        case "regularOpeningHours":
                            try {
                                a.nh = f && f ? .periods ? .length ? new WD(f) : null
                            } catch (g) {
                        ...
                        case "currentOpeningHours":
                            try {
                                a.mh = f && f ? .weekdayDescriptions ? .length ? new WD(f) : null
                            } catch (g) {
                        ...
                        case "currentSecondaryOpeningHours":
                            a.Bh = f.map(g => new XD(g));
                            break;
                        case "parkingOptions":
                            a.Qh = f ? new YD(f) : null;
                            break;
                        case "paymentOptions":
                            a.Ph = f ? new ZD(f) : null;
                            break;
                        case "photos":
                            a.Vh = f.map(g => {
                                try {
                            ...
                            break;
                        case "plusCode":
                            a.qh = f ? new _.Qu(f) : null;
                            break;
                        case "postalAddress":
                            a.rh = f ? new _.Ru(f) : null;
                            break;
                        case "priceRange":
                            c = {};
                            a.requestedLanguage != null && (c.language =
                                a.requestedLanguage);
                            a.requestedRegion != null && (c.region = a.requestedRegion);
                            a.Xh = f ? new Gra(f, c) : null;
                            break;
                        case "reviews":
                            a.mi = f.map(g => new aE(g));
                            break;
                        case "reviewSummary":
                        ...
                        case "addressDescriptor":
                            a.wh = f ? new Jra(f, g => a.Au(g)) : null;
                            break;
                        case "busyness":
                            a.yh = f ? new Kra(f) : null;
                            break;
                        case "containingPlaces":
                            a.Ah =
                                f ? f.map(g => a.Au(g)) : null
                    }
                }
                a.Di = { ...a.Di,
                    ...b
            ...
            Nra = function(a, b, c) {
                ...
                if (Lra(a)) return !0;
                const d = new cE(c.getUTCDay(), c.getUTCHours(), c.getUTCMinutes(), 0);
                return Mra(a, b).some(e =>
                    e.includes(d))
            },
            Lra = function(a) {
            ...
            Mra = function(a, b) {
                ...
                a.forEach(d => {
                    var e = d.close;
                    d = d.open;
                    e = new dE(new cE(d.day, d.hour, d.minute, b), new cE(e.day, e.hour, e.minute, b));
                    e.endTime.compare(e.startTime) < 0 ? (d = new dE(new cE(0, 0, 0, 0), e.endTime), c.push(new dE(e.startTime, new cE(0, 0, 10080, 0))), c.push(d)) : c.push(e)
                });
                return c
            },
            Ora = function(a) {
        ...
        `
                ...
                if (Nra(d, c, f)) {
                    f = tra(b, f.getTime(), c);
                    if (!f) return null;
                    e = BD("Closes {nextClosingTime}", {
                        nextClosingTime: fE(a, {
                            timeStyle: "short",
                            timeZone: e
                        }, f)
                    });
                    ...
                    e =
                        BD("{nextOpeningDayOfWeek, select,null {Opens {nextOpeningTime}}other {Opens {nextOpeningTime} {nextOpeningDayOfWeek}}}", {
                            nextOpeningTime: fE(a, {
                                timeStyle: "short",
                                timeZone: e
                            }, b),
                            nextOpeningDayOfWeek: c === fE(a, {
                                weekday: "short",
                                timeZone: e
                            }, f) ? "null" : c
                        });
    ...
    `
            ...
            Rra = function(a) {
                ...
                try {
                    b = fE(a, {
                        weekday: "long",
                        timeZone: Ora(a.place.utcOffsetMinutes)
                    }, new Date)
                } catch (d) {
                    return !1
                }
      ...
      <div class="translation-container">
        <button class="translation-button" @click=${a.mh}>
          ${a.ix?(0,_.Q)`<span class="toggle-translation-text"
              ...
              >`:(0,_.Q)`
                ${TD((0,_.Q)`<span class="translated-by"
  ...
  `
            ...
            Xra = function(a = !1) {
                ...
                `<div
    class="load-error"
    aria-label=${a?_.Pt:"Image couldn't load"}
  ...
  >`
    ...
    ${a.map((c,d)=>{d=["image-container",`grid-item-${d}-${a.length}`,...b].join(" ");return(0,_.Q)`<div class=${d}>${c}</div>`})}
            ...
            Zra = async function(a, b) {
                a.gv && (b !== a.gv.currentPhotoIndex && (a.gv.currentPhotoIndex = b, await a.gv.cq), a.gv.show())
            },
            $ra = async function(a, b) {
                if (a = a.mh[b] ? .nu)(new Image).src = a
            },
            asa = function(a) {
            ...
            bsa = function(a, b, c) {
                var d = 4;
                if (a.KE) {
                    var e = window.getComputedStyle(a.KE).gap;
            ...
            dsa = function(a) {
                if (a.photoDisplayDataList.length === 0) return gE([(0, _.Q)
          ...
          ${Yra(a.mini)}
                ...
                const b = Math.min(a.maxPhotos, a.photoDisplayDataList.length),
                    c = a.photoDisplayDataList.slice(0, b).map((f, g) => {
                        const h = BD("{NUM_IMAGE, selectordinal,    one {Open the #st photo.}   two {Open the #nd photo.}   few {Open the #rd photo.}   other {Open the #th photo.}}", {
                                NUM_IMAGE: g + 1
                            }),
                            k = encodeURI(csa(f.uri, bsa(a, g, b)));
                        f = new Image;
                        const n = _.to();
            ...
            `: (0, _.Q)
                    ...
                    d = a.lightboxEnabled ? Wra(a.photoDisplayDataList.length, a.lightboxAffordanceType) : "",
          ...
          .photoDisplayDataList=${a.mh}></gmp-internal-lightbox>`: "";
            ...
            hE = function(a, b) {
                [a] = a.split("=");
                return (b = [...(b.width ? [`w${Math.ceil(b.width)}`] : []), ...(b.eK ? ["c"] : []), ...(b.height ? [`h${Math.ceil(b.height)}`] : [])].join("-")) ? `${a}=${b}` : a
            },
            csa = function(a, b) {
                return a.includes("googleusercontent.com") ? hE(a, {
                    width: b.widthPx,
                    height: b.heightPx,
                    eK: !0
                }) : a
            ...
            gsa = function(a, b, c) {
                ...
                d = BD("{USER_RATING_COUNT, plural,   =1 {# review}  other {# reviews}}", {
                    USER_RATING_COUNT: d
                });
                return (0, _.Q)
                `<span part="reviews"
    ><span aria-hidden="true">(</span>${a.googleMapsURI?(0,_.Q)`<a
        ...
        target="_blank"
        .ariaLabel=${_.Pr(d)}
        @click=${e=>{c&&e.stopPropagation();_.N(a,311375)}}
        >${b}</a
            ...
            lsa = function(a) {
                ...
                a = jsa.map(c => {
                    ...
                    return {
                        SK: c,
                        price: d ? ? null,
                        qH: e ? e.getTime() < Date.now() - 864E5 : null
                    }
                });
                return (0, _.Q)
                `
  ...
  `
            ...
            ksa = function({
                ...
                a = BD("{FUEL_TYPE, select,  REGULAR_UNLEADED {Regular}  MIDGRADE {Midgrade}  PREMIUM {Premium}  DIESEL {Diesel}  other {}}", {
                    FUEL_TYPE: a
                });
                return (0, _.Q)
                `
  ...
  `
            ...
            msa = function(a, b) {
                ...
                a = BD("{EV_CONNECTOR_TYPE, select,  CCS_COMBO_1 {CCS}  CCS_COMBO_2 {CCS}  CHADEMO {CHAdeMO}  J1772 {J1772}  TESLA {Tesla}  NACS {NACS}  TYPE_2 {Type 2}  UNSPECIFIED_GB_T {GB/T}  UNSPECIFIED_WALL_OUTLET {Wall outlet}  other {Unknown connector}}", {
                    EV_CONNECTOR_TYPE: a.type
                });
                const g = h => d == null ? null : BD("{VARIANT, select,  short {{AVAILABLE_COUNT}/{TOTAL_COUNT}}  standalone {{AVAILABLE_COUNT} out of {TOTAL_COUNT} available}  other {}}", {
                    VARIANT: h,
                    AVAILABLE_COUNT: d,
                    TOTAL_COUNT: c
                });
  ...
  `
            ...
            tsa = function() {
                for (const [a, b] of rsa.entries()) _.zp(a, b);
                for (const [a, b] of ssa.entries()) _.zp(a, b)
            },
            jE = function(a) {
            ...
            kE = function(a, b) {
                if (a === b) return !0;
                if (jE(a) !== jE(b)) return !1;
                if (jE(a)) return a.equals(b);
                if (Array.isArray(a) && Array.isArray(b)) {
                    if (a.length !== b.length) return !1;
                    for (var c = 0; c < a.length; c++)
                        if (!kE(a[c], b[c])) return !1;
                    return !0
                }
                if (a && b && typeof a === "object" && typeof b === "object" && !Array.isArray(a) && !Array.isArray(b)) {
                    a = usa(a).filter(([, d]) => d !== void 0);
                    b = usa(b).filter(([, d]) => d !== void 0);
                    if (a.length !== b.length) return !1;
                    for (c = 0; c < a.length; c++) {
                        const [d, e] = a[c], f = d, g = e, [h, k] = b[c],
                            n = k;
                        if (f !== h || !kE(g, n)) return !1
                    }
                    return !0
                }
                return !1
                ...
                if (b.contentConfig ? .price) {
                    {
                        ...
                        if (f && f.startPrice) {
                            var d = new pD("#,##0", f.startPrice.currencyCode);
                            var e = wqa(f.startPrice.currencyCode);
                            d = f.endPrice ? (0, _.Q)
                            `
    <span
  ...
  `: (0, _.Q)
      ...
      >
    `
                        } else(e = a.priceLevel) && e !== "FREE" ? (d = BD("{PRICE_LEVEL, select,  INEXPENSIVE { $}  MODERATE { $$}  EXPENSIVE { $$$}  VERY_EXPENSIVE { $$$$}  other {}}", {
                                PRICE_LEVEL: e
                            }), e = BD("{PRICE_LEVEL, select,  INEXPENSIVE {Inexpensive}  MODERATE {Moderately Expensive}  EXPENSIVE {Expensive}  VERY_EXPENSIVE {Very Expensive}  other {}}", {
                                PRICE_LEVEL: e
                            }), d = (0, _.Q)
                            `
  ...
  `) : d = null
                ...
                a = b.contentConfig ? .accessibleEntranceIcon ? vsa(a, !c && !d) : null;
                return c || d || a ? (0, _.Q)
                ` ${TD(c,d,a)} `: null
            },
            vsa = function(a, b = !1) {
                ...
                `
    ${xsa({className:"wheelchair",ariaHidden:b?"true":"false",lO:b?"":"Accessible entrance"})}
  ...
  `: null
                ...
                for (const {
                    ...
                    case lE:
                        ...
                        for (const e of Object.keys(b))
                            if (!(e in a.ph)) {
                                const f = ysa.get(e) || e;
                                _.lq(a, `'${f}' is not a supported content config.`)
                            }
                        return b;
                    case mE:
                        return a.Gh;
            ...
            Esa = function(a, b) {
                ...
                a = Vqa(new Csa, Asa(a));
                return Yqa(c.mh, a, b).then(d => _.bg(d, Dsa, 1))
            },
            Fsa = function(a) {
                if (!a ||
            ...
            rE = function(a, b) {
                ...
                for (const d of b) switch (d) {
                    case "accessibilityOptions":
                        c.accessibilityOptions = Hsa(a.wh());
                        break;
                    case "addressComponents":
                        b = a.xh().map(e => ({
                            longText: e.nh(),
                    ...
                    case "adrFormatAddress":
                        c.adrFormatAddress = a.zJ() || null;
                        break;
                    case "allowsDogs":
                        c.allowsDogs = a.Tn() ? a.zh() : null;
                        break;
                    case "attributions":
                        b = a.MJ().map(e => ({
                            provider: e.nh(),
                        ...
                        break;
                    case "businessStatus":
                        c.businessStatus = Jsa.get(a.SJ()) || null;
                        break;
                    case "consumerAlert":
                        c.consumerAlert = Ksa(a.qK());
                        break;
                    case "containingPlaces":
                        c.containingPlaces = a.uK().map(e => ({
                            id: e.getId(),
                    ...
                    case "evChargeAmenitySummary":
                        ...
                        break;
                    case "fuelOptions":
                        c.fuelOptions = Msa(a.Lh());
                        break;
                    case "formattedAddress":
                        c.formattedAddress = a.Hh() || null;
                        break;
                    case "shortFormattedAddress":
                        c.shortFormattedAddress = a.uM() || null;
                        break;
                    case "generativeSummary":
                        b = a.wL();
                        c.generativeSummary = b ? {
                            ...
                            overviewLanguageCode: b.ph() ? .nh() ||
                                null
                        } : null;
                        break;
                    case "googleMapsLinks":
                        c.googleMapsLinks = Nsa(a.RL());
                        break;
                    case "googleMapsURI":
                        c.googleMapsURI = a.Vh() || null;
                        break;
                    case "hasCurbsidePickup":
                        c.hasCurbsidePickup = a.hasCurbsidePickup() ? a.Bh() : null;
                        break;
                    case "hasDelivery":
                        c.hasDelivery = a.hasDelivery() ? a.Ch() : null;
                        break;
                    case "hasDineIn":
                        c.hasDineIn = a.hasDineIn() ? a.Fh() : null;
                        break;
                    case "hasLiveMusic":
                        c.hasLiveMusic = a.hasLiveMusic() ? a.Zh() : null;
                        break;
                    case "hasMenuForChildren":
                        c.hasMenuForChildren = a.hasMenuForChildren() ? a.ci() : null;
                        break;
                    case "hasOutdoorSeating":
                        c.hasOutdoorSeating = a.hasOutdoorSeating() ? a.pi() : null;
                        break;
                    case "hasRestroom":
                        c.hasRestroom = a.hasRestroom() ? a.Fj() : null;
                        break;
                    case "hasTakeout":
                        c.hasTakeout = a.hasTakeout() ? a.Am() : null;
                        break;
                    case "hasWiFi":
                        c.hasWiFi = a.eN() ? a.ZM() : null;
                        break;
                    case "iconBackgroundColor":
                        c.iconBackgroundColor = a.TL() || null;
                        break;
                    case "internationalPhoneNumber":
                        c.internationalPhoneNumber = a.Xh() || null;
                        break;
                    case "isGoodForChildren":
                        c.isGoodForChildren = a.Un() ? a.Nh() : null;
                        break;
                    ...
                    case "isGoodForWatchingSports":
                        c.isGoodForWatchingSports = a.tp() ? a.Ph() : null;
                        break;
                    case "isPureServiceAreaBusiness":
                        c.isPureServiceAreaBusiness = a.lv() ? a.wj() : null;
                        break;
                    case "isReservable":
                        c.isReservable = a.mv() ? a.Xj() : null;
                        break;
                    case "location":
                        a.rr() ? (b = {
                    ...
                    case "nationalPhoneNumber":
                        c.nationalPhoneNumber = a.mi() || null;
                        break;
                    case "neighborhoodSummary":
                        b = a.YL();
                        ...
                        break;
                    case "regularOpeningHours":
                        c.regularOpeningHours = qE(a.Ej());
                        break;
                    case "currentOpeningHours":
                        c.currentOpeningHours = qE(a.IK());
                        break;
                    case "regularSecondaryOpeningHours":
                        b = a.oM().map(e => Osa(e));
                    ...
                    case "postalAddress":
                        ...
                        break;
                    case "priceLevel":
                        c.priceLevel = Qsa.get(a.Zi()) || null;
                        break;
                    case "priceRange":
                        c.priceRange = a.kv() ? Rsa(a.Bj()) : null;
                        break;
                    case "primaryType":
                        c.primaryType = a.oj() || null;
                        break;
                    ...
                    case "servesBreakfast":
                        c.servesBreakfast = a.jA() ? a.gk() : null;
                        break;
                    case "servesCocktails":
                        c.servesCocktails = a.xI() ? a.nk() : null;
                        break;
                    case "servesCoffee":
                        c.servesCoffee = a.zI() ? a.Ik() : null;
                        break;
                    case "servesDessert":
                        c.servesDessert = a.DI() ? a.Qk() : null;
                        break;
                    case "servesLunch":
                        c.servesLunch = a.OI() ? a.bl() : null;
                        break;
                    case "servesDinner":
                        c.servesDinner = a.HI() ? a.al() : null;
                        break;
                    case "servesBeer":
                        c.servesBeer = a.iA() ? a.Yj() : null;
                        break;
                    case "servesWine":
                        c.servesWine = a.RI() ? a.Ql() : null;
                        break;
                    case "servesBrunch":
                        c.servesBrunch = a.wI() ? a.ik() : null;
                        break;
                    case "servesVegetarianFood":
                        c.servesVegetarianFood = a.QI() ? a.pl() : null;
                        break;
                    case "subDestinations":
                        b = a.DM().map(e => ({
                            id: e.getId(),
                    ...
                    case "userRatingCount":
                        c.userRatingCount = a.UI() ? a.Zm() : null;
                        break;
                    case "utcOffsetMinutes":
                        c.utcOffsetMinutes = a.VI() ? a.Do() : null;
                        break;
                    case "viewport":
                        if (a.WI()) {
                            b = _.qi(a.nh()).nh();
            ...
            Msa = function(a) {
                return a == null ? null : {
                    fuelPrices: a.nh().map(b => {
                        ...
                        return {
                            type: Vsa.get(b.getType()) ? ? null,
                            price: b.qh() ? sE(b.nh()) : null,
                            updateTime: c ? (new Date(Number(_.og(c, 1)) * 1E3 + _.ig(c, 2) / 1E6)).toISOString() : null
                        }
                    })
                }
            },
            Lsa = function(a) {
                return a == null ? null : {
                    ...
                    connectorAggregations: a.nh().map(b => {
                        ...
                        c = c ? (new Date(Number(_.og(c, 1)) * 1E3 + _.ig(c, 2) / 1E6)).toISOString() : null;
                        return {
                            type: Wsa.get(b.getType()) ? ? "OTHER",
            ...
            qE = function(a) {
                ...
                a != null && (b.periods = a.nh().map(c => {
                    ...
                    return d
                }), b.weekdayDescriptions = a.rh().slice(), b.specialDays = a.qh().map(c => (new Date(Date.UTC(c.nh().ph(), c.nh().nh() - 1, c.nh().qh()))).toISOString()));
                return b
            },
            Osa = function(a) {
                var b = {
            ...
            Rsa = function(a) {
                return a.rh() ? {
                    startPrice: sE(a.ph()),
                    endPrice: a.qh() ? sE(a.nh()) : null
                } : null
            },
            sE = function(a) {
                return {
                    currencyCode: _.J(a, 1),
                    units: Number(_.og(a, 2)),
                    nanos: _.ig(a, 3)
                }
            },
            Ssa = function(a) {
                var b = a.zh() ? a.yh() : null;
                b = b ? (new Date(Number(_.og(b, 1)) * 1E3 + _.ig(b, 2) / 1E6)).toISOString() : null;
                const c = a.xh() ? ? null;
                return {
            ...
            bta = function(a) {
                return {
                    ...
                    spatialRelationship: ata.get(a.ph()) ? ? "NEAR",
            ...
            dta = function(a) {
                return {
                    ...
                    containment: cta.get(a.nh()) ? ? null
                }
            },
            Isa = function(a) {
                return a == null ? null : {
                    landmarks: a.ph().map(bta),
                    areas: a.nh().map(dta)
                }
            },
            tE = function(a) {
                return [...(new Set(a.map(b => eta.get(b) || b)))]
            },
            gta = function(a) {
                a = uE(a);
                if (!a.length) throw _.Wm("fields array must not be empty");
                const b = a.filter(c => !fta.has(c) && c !== "*");
            ...
            ita = function(a) {
                const b = _.ls(a);
                if (b instanceof _.Bo || b instanceof _.un || b instanceof _.Np || b ===
                    "IP_BIAS") return b;
            ...
            pta = function(a) {
                ...
                return _.fn([_.Jr, _.Ao, _.Op, _.et])(a)
            },
            wE = function(a, {
                requestedLanguage: b,
                requestedRegion: c
            ...
            qta = async function(a, b) {
                ...
                c.fields.includes("*") && (c.fields = [...xE]);
                const d = c.fields.filter(e => e !== "resourceName");
                c.fields = tE(c.fields);
                ({
                        HN: a
                    } =
                ...
                try {
                    return {
                        places: (await a(c, b)).mB().map(e => rE(_.lf(e), d)).map(e => wE(e, {
                            requestedLanguage: c.language,
                            requestedRegion: c.region
                        }))
                    }
                } catch (e) {
                    if (e instanceof _.Ik) throw _.is("Error in searchByText: " + e.message, "PLACES_SEARCH_TEXT", e);
                    throw e;
                }
            },
            rta = async function(a, b) {
                const c = lta(a);
                c.fields.includes("id") || c.fields.push("id");
                c.fields.includes("*") && (c.fields = [...xE]);
                const d = c.fields.filter(e => e !== "resourceName");
                ...
                try {
                    ...
                    if (e instanceof _.Ik) throw _.is("Error in searchNearby: " + e.message, "PLACES_NEARBY_SEARCH", e);
                    throw e;
                }
            },
            uta = async function(a, b, c) {
                var d = _.Ym({
                    fields: sta,
                    sessionToken: _.hn(_.$m(_.Nu, "AutocompleteSessionToken"))
                })(b);
                d.fields.includes("*") && (d.fields = [...xE]);
                ...
                try {
                    ...
                    if (g instanceof _.Ik) throw _.is("Error fetching fields: " + g.message, "PLACES_GET_PLACE", g);
                    throw g;
                }
            },
            tta = function(a, b) {
                ...
                [...b].forEach(d => {
                    switch (d) {
                        ...
                        case "subDestinations":
                            ...
                            break;
                        case "busyness":
                            c.busyness = _.Dm(a.busyness, null);
                            break;
                        case "containingPlaces":
                            c.containingPlaces = _.Dm(a.containingPlaces, []);
                            break;
                        case "addressDescriptor":
                            c.addressDescriptor = _.Dm(a.addressDescriptor,
                                null)
                    }
                });
                return c
                ...
                a.Pw.forEach(c => {
                    switch (c) {
                        ...
                        case "nationalPhoneNumber":
                            ...
                            break;
                        case "regularOpeningHours":
                            b.regularOpeningHours = a.regularOpeningHours ?
                                a.regularOpeningHours.toJSON() : null;
                            break;
                        case "currentOpeningHours":
                        ...
                        case "paymentOptions":
                            b.paymentOptions =
                                a.paymentOptions ? a.paymentOptions.toJSON() : null;
                            break;
                        case "photos":
                        ...
                        case "editorialSummaryLanguageCode":
                            ...
                            break;
                        case "evChargeOptions":
                            b.evChargeOptions = a.evChargeOptions ? .toJSON() ? ?
                                null;
                            break;
                        case "fuelOptions":
            ...
            sta = function(a) {
                a = vta(a);
                const b = new Set([...wta, "openingHours"]),
            ...
            yta = function(a) {
                return new Set(["displayName",
                    "googleMapsURI", ...Object.keys(a).map(b => xta[b]).flat()
                ])
            },
            zta = function(a, b) {
                return b.media ? !1 : Array.from(yta(b)).every(c => a[c] !== void 0)
            },
            Cta = async function(a, b = {}, c) {
                return c(await Promise.all((a.photos ? ? []).map(async d => Ata(d, b, c).catch(Bta))))
            },
            Ata = async function(a, b = {}, c) {
                const {
                    pF: d
                ...
                try {
                    ...
                    if (e instanceof _.Ik) throw _.is(`Error fetching photo URI: ${e.message}`,
            ...
            Gta = async function(a, b) {
                ...
                AE(a);
                await _.Hr(a, async c => {
                    if (a.nh) {
                        var d = c(await a.nh.fetch(c)),
                            e = c(await Eta(a, b, d.fo(), d.nh()));
                        a.Ak = e;
                        a.Dk = 2;
                        c(await Fta(a, e, d.fo(), c))
                    } else _.N(a, 263055)
                }, 230164)
            },
            Ita = async function(a,
                ...
                await _.Hr(a, async c => {
                    if (a.nh) {
                        var d = c(await a.nh.fetch(c)),
                            e = c(await Hta(b, d.fo()));
                        a.Ak = c(await Eta(a, {
                            id: e
                        }, d.fo(), d.nh()));
                        a.Dk = 2;
                        c(await Fta(a, a.Ak, d.fo(), c))
                    } else _.N(a, 263055)
                }, 230165)
            },
            AE = function(a) {
            ...
            Eta = async function(a, b, c, d) {
                const e = {
                    requestedLanguage: a.Dh.language,
                    requestedRegion: a.Dh.region
                };
                b = b instanceof vE ? wE(yE(b), e) : new vE({ ...e,
                    ...b
                });
                a = Gsa(new Set([...Jta, ...a.xh]), d);
                await uta(b, {
                    fields: Array.from(a)
                }, {
                    lm: c
            ...
            Fta = async function(a, b, c, d) {
                ...
                a.Tr = a.photoDisplayDataList.length ===
      ...
      `: ""
            ...
            Mta = function(a, {
                ...
                const c = Lta[b];
                return (0, _.Q)
                `${Kta(a.googleMapsURI??null,c.text,{showIcon:c.showIcon,TJ:{["open-in-maps-button"]:!0,[b]:!0},dM:a,cM:254684,ariaLabel:_.Pr("Open in Maps")})}`
            },
            Nta = function(a, b = !1) {
                return (0, _.Q)
    ...
    ${b?"":BE(void 0,{showInfoButton:!0,Qz:!0,attributionType:"TEXT",infoButtonTapAreaExpanded:!1,contentConfig:a})}
            ...
            DE = function(a, b = {
                ...
                h = h ? rra(a) : "";
                if (d)
                    if (d.hF == null && d.distanceMeters == null) var w = (0, _.Q)
                ``;
                else {
                    w = d.distanceMeters;
                    d = d.hF;
                    if (d == null && w == null) w = {};
                        ...
                        var y = _.sl.nh(),
                            E = y.nh() || void 0;
                        y = (y = !y.qh() && y.ph() || void 0) && _.qha.has(y.toUpperCase()) ? 1 : 0;
                        var H = void 0,
                            M = void 0;
  ...
  `
    ...
    <section class="basic-info">
      ...
      ${w}
      ${c}
      ${e?null:BE(a,{contentConfig:p,Qz:!1,attributionType:"TEXT",infoButtonTapAreaExpanded:k,showInfoButton:!0})}
    </section>
  `
            },
            BE = function(a, b = {}) {
                ...
                a = [...(a ? .rating != null && d ? .rating || b ? [iE] : []), ...(b ? [hsa] : []), Ota];
  ...
  `: null
    ...
    ${new _.Wr({title:"Google Maps",GH:!1,content:c})}`
            },
            Rta = function(a) {
                return EE(a) ? null : BE(a.Ak, {
          ...
          `: null
            ...
            EE = function(a) {
                return !(a.Dh.showsAttribution ? ? !0) || _.Mq[35]
            },
            Sta = function(a) {
                var b = a.place;
                const c = a.contentConfig;
                a = c ? .typeSpecificHighlights ? SD([lsa(b), psa(b)]) : null;
                var d = Qta(b);
                const e = b.internationalPhoneNumber ? ? (b.nationalPhoneNumber || "");
                var f = c ? .address && b.formattedAddress && PD((0, _.Q)
        ...
        `, h;
                if (h = c ? .website && b.websiteURI) {
                    ...
                    h = PD(h, n, qsa, b.websiteURI, !1, ["website-link"])
                }
                b = [f, g, h, c ? .phoneNumber && e && PD((0, _.Q)
                    ...
                    e, esa, `tel:+${e.replace(/[-()\s+]/g,"")}`, !0), c ? .plusCode && b.plusCode ? .compoundCode && PD((0, _.Q)
                    `<svg fill="currentColor" aria-hidden="true" shape-rendering="geometricPrecision" viewBox="0 0 24 24"><path d="M12 7a2 2 0 100-4 2 2 0 000 4m-5 5a2 2 0 11-4 0 2 2 0 014 0m5 2a2 2 0 100-4 2 2 0 000 4m7 0a2 2 0 100-4 2 2 0 000 4m-5 5a2 2 0 11-4 0 2 2 0 014 0"/></svg>`, b.plusCode ? .compoundCode, fsa)].filter(Boolean);
                return SD([d, a, b.length ? (0, _.Q)
                    `
  ...
  `
                ...
                return SD([c, d, a ? .reviews ? isa(b) : null])
            },
            Uta = function(a) {
                const b = a.place,
                    c = a.contentConfig;
                ...
                return [{
                    ...
                    name: "About",
                    content: c ? .featureList ? qra(b) : null
                }].filter(e => !!e.content)
            },
            Vta = function(a) {
    ...
    `: a.length === 1 ? (0, _.Q)
            ...
            GE = function(a) {
                return a.Dh.showsAttribution ? ? !0 ? BE(a.Ak, {
                    contentConfig: a.contentConfig,
                    showInfoButton: !0,
                    Qz: !0,
          ...
          `: null
            ...
            Zta = function(a) {
                return {
                    width: a.clientWidth,
                    UB: a.scrollLeft,
                    wN: a.scrollLeft + a.clientWidth,
                    xG: a.scrollWidth - a.clientWidth,
            ...
            aua = function(a, b) {
                ...
                a: {
                    if (b === 1)
                        for (f = a.hn.length - 1; f >= 0; f--)
                            if (JE(HE(a.hn[f]), c)) break a;
                    for (f = 0; f < a.hn.length; f++)
                        if (JE(HE(a.hn[f]), c)) break a;f = void 0
                } {
                    const h = c.Ij;
                    if (f) {
                        var g = HE(a.hn[f + b]);
                        c = b === 1 !== h ? g.jG - $ta(a) : g.dH - c.width + $ta(a)
                    } else c = c.width * .8 * b, c = a.oq.scrollLeft + (h ? -c : c)
                }
                ...
                f && (a.FN.textContent = "Card " + String(f + b + 1) + " of " + String(a.hn.length));
                KE(a)
            },
            LE = async function(a) {
            ...
            KE = function(a) {
                const b = Zta(a.oq),
                    c = HE(a.hn[a.hn.length - 1]),
                    d = a.shadowRoot.activeElement,
                    e = b.UB === 0;
                var f = Math.abs(b.UB) -
                    b.xG;
                f = f >= -1 && f <= 1;
                JE(HE(a.hn[0]), b) || e ? Xta(a.yt, d === a.yt ? a.yw : null) : Yta(a.yt);
                JE(c, b) || f ? Xta(a.yw, d === a.yw ? a.yt : null) : Yta(a.yw);
            ...
            $ta = function(a) {
                const b = IE(getComputedStyle(a.sM).paddingLeft);
                a = IE(getComputedStyle(a.yt).width) +
                    IE(getComputedStyle(a.yt).margin);
                return b + a - 6
            },
            ...
            dua = async function(a, b = {}, c) {
                ...
                try {
                    ...
                    if (e instanceof _.Ik) throw _.is(`Error fetching photo URI: ${e.message}`, "PLACES_GET_PHOTO_MEDIA", e);
                    throw e;
                }
            },
            fua = function(a, b) {
            ...
            jua = function(a, b = {}) {
                ...
                a = [...(a ? .some(g => g.place ? .rating != null) && c ? .rating ? [iE] : []), ...(a ? .length ? [hua] : [])];
                b = iua.get(c ? .attribution ? .lightSchemeColor || "GRAY");
                const f = iua.get(c ? .attribution ? .darkSchemeColor || "WHITE");
                return (0, _.Q)
                `
    <gmp-internal-attribution
      .infoButtonTapAreaExpanded=${!0}
  ...
  `
            ...
            >${e}</div
          >`;
                b = d.displayName ? BD("Select {placeName}", {
                    placeName: d.displayName
                }) : "Select this place";
                const f = h => {
                        a.selectable && (a.dispatchEvent(new PE(zE(d))), h.stopPropagation())
                    },
                    g = h => {
                        !a.selectable || h.key !== "Enter" && h.key !== " " || h.target !== h.currentTarget || (a.dispatchEvent(new PE(zE(d))), h.preventDefault(), h.stopPropagation())
                    };
          ...
          ${e}
            ...
            lua = function(a, b) {
                return b !== a.attributionPosition ? _.Pt : (0, _.Q)
      ...
      ${jua(a.qq,{contentConfig:a.ek.content,showInfoButton:!0})}
            ...
            nua = async function(a, b) {
                const {
                    GJ: c
                } = await _.Wl("places_impl"), d = ota(a);
                try {
                    return c(d, b).then(e => ({
                        suggestions: e.HJ.nh().map(f => {
                            var g = e.CE.rh(),
                                h = e.CE.qh(),
                                k = a ? .sessionToken,
                                n = a ? .origin && new _.un(a.origin);
                            return new QE(f, g, h, k, n)
                        })
                    }))
                } catch (e) {
                    if (e instanceof _.Ik) throw _.is("Error in fetching AutocompleteSuggestions: " + e.message, "PLACES_AUTOCOMPLETE", e);
                    throw e;
                }
            },
            SE = function(a) {
            ...
            hra = function(a, b) {
                ...
                if (a.xi.assignedElements().length === 0) var k = null;
                else {
                    if (a.xi.assignedElements().length > 1) throw _.Wm(_.iq(a, "You may specify a maximum of one element for the prediction-item-icon slot."));
                    k = a.xi.assignedElements()[0];
                    if (!(k instanceof HTMLTemplateElement)) throw _.Wm(_.iq(a, "You may only specify a <template> element for the prediction-item-icon slot."));
                ...
                k ? h.appendChild(k) : ({
                    ...
                    `<svg class="${k}" viewBox="0 -960 960 960"><path d="M480-480q33 0 56.5-23.5T560-560t-23.5-56.5T480-640t-56.5 23.5T400-560t23.5 56.5T480-480m0 294q122-112 181-203.5T720-552q0-109-69.5-178.5T480-800t-170.5 69.5T240-552q0 71 59 162.5T480-186m0 106Q319-217 239.5-334.5T160-552q0-150 96.5-239T480-880t223.5 89T800-552q0 100-79.5 217.5T480-80m0-480"/></svg>`,
                    h));
                ...
                b.distanceMeters == null ? a = null : (f = b.distanceMeters, b = a.Ti != null ? a.Ti : _.qha.has(a.Zh ? ? "") ? 1 : 0, f /= b === 1 ? 1609.34 : 1E3, a = (new Intl.NumberFormat(a.bl ? ? void 0, {
                    style: "unit",
                    unit: b === 1 ? "mile" : "kilometer",
                    unitDisplay: "short",
                    maximumFractionDigits: f <
                        10 ? 1 : 0
                })).format(f), b = document.createElement("span"), b.textContent = `${a} \u00b7 `, a = b);
                a && e.prepend(a);
            ...
            vua = async function(a) {
                a.mi || (a.mi = a.Do.fetch(uua).then(b => {
                    a.rh = b.fo()
                }).finally(() => {
                    a.mi = null
                }));
                ...
                return {
                    ...
                    places: b.qh().map(c => {
                        var d = {
                            ...
                            priceLevel: Qsa.get(c.Zh()) ? ? null,
                            fuelOptions: Msa(c.Ah()),
                            evChargeOptions: Lsa(c.yh()),
                            regularOpeningHours: qE(c.mi()),
                            utcOffsetMinutes: c.Pj() ? ? null,
                            accessibilityOptions: Hsa(c.qh()),
                            formattedAddress: c.zh() || null,
                            websiteURI: c.Yj() || null,
                            nationalPhoneNumber: c.Vh() || null,
                            internationalPhoneNumber: c.Lh() || null,
                            ...
                            hasRestroom: c.hasRestroom() ? c.xi() : null,
            ...
            wua = function(a) {
                ...
                return {
                    ...
                    photoDisplayDataList: a.sp().map(c => zua(c, b)),
                    UC: a.bl() && a.nh().Hr().length > 0 ? {
                        hF: vqa(a.nh().Hr()[0].hj() ? .nh()),
            ...
            xua = function(a) {
                ...
                return {
                    mapMode: b,
                    rR: a.qh() ? {
                        tilt: vqa(a.ph().getTilt())
                    } : null
                }
            },
            Bua = async function(a) {
                await _.Hr(a, async b => {
                    a.ZG = void 0;
                    a.nh = null;
                    a.oh = null;
                    a.mh = null;
                    if (a.contextToken != null) {
                        const {
                            HK: c
                        } = b(await _.Wl("places_impl")), d = b(await a.rh.WA(a.contextToken, b));
                        a.ZG = yua(b(await c({
        ...
        _.Gs.prototype.nh = _.da(2, function() {
            return _.lg(this, 1)
        });
        var Cua = {
                cE: {
        ...
        pD.prototype.format = function(a) {
            if (this.nh > this.mh) throw Error("Min value must be less than max value");
            if (_.Dfa && this.rh) {
                (this.rh.format == null || this.Ch || this.qh || this.Vh || Bqa) && yqa(this, this.Ph);
            ...
            if (isNaN(a)) return nD.rI;
            b = [];
            var c = a,
                d = a;
            if (this.wh == 0) var e = uD;
            else c = Math.abs(c), d = Math.abs(d), e = Eqa(this, c <= 1 ? 0 : vD(c)).LA, d = mD(d, -e), rD(this, d),
                c = mD(c, -e), c = rD(this, c), e = Eqa(this, e + vD(c.VF));
            a = mD(a, -e.LA);
            (c = a < 0 || a == 0 && 1 / a < 0) ? e.jC ? b.push(e.jC) : (b.push(e.prefix), b.push(this.Ah)): (b.push(e.prefix), b.push(this.Gh));
            if (isFinite(a))
                if (a *= c ? -1 : 1, a *= this.ph, this.Fh)
                    if (d = a, d == 0) sD(this, d, this.oh, b), Dqa(this, 0, b);
                    else {
                        var f = Math.floor(Math.log(d) / Math.log(10) + 2E-15);
                        d = mD(d, -f);
                        var g = this.oh;
                        this.xh > 1 && this.xh > this.oh ? (g = f % this.xh, g < 0 && (g = this.xh + g), d = mD(d, g), f -= g, g = 1) : this.oh < 1 ? (f++, d = mD(d, -1)) : (f -= this.oh - 1, d = mD(d, this.oh - 1));
                        sD(this, d, g, b);
                        Dqa(this,
                            f, b)
                    }
            else sD(this, a, this.oh, b);
            else b.push(nD.kI);
            c ? e.kC ? b.push(e.kC) : (isFinite(a) && b.push(e.suffix), b.push(this.Bh)) : (isFinite(a) && b.push(e.suffix), b.push(this.Hh));
            return b.join("")
        };
        var Fqa = null,
            Gqa = null,
            Hqa = null,
            Kqa = /^\s*(\w+)\s*,\s*plural\s*,(?:\s*offset:(\d+))?/,
            Lqa = /^\s*(\w+)\s*,\s*selectordinal\s*,/,
            Mqa = /^\s*(\w+)\s*,\s*select\s*,/;
        wD.prototype.format = function(a) {
            if (this.oh) {
                this.qh = [];
                var b = Jqa(this, this.oh);
                this.nh = zD(this, b);
                this.oh = null
            }
            if (this.nh && this.nh.length != 0)
                for (this.mh = _.Zb(this.qh), b = [], xD(this, this.nh, a, !1, b), a = b.join(""), a.search("#"); this.mh.length > 0;) a = a.replace(this.ph(this.mh), String(this.mh.pop()).replace("$", "$$$$"));
            else a = "";
            return a
        };
        wD.prototype.ph = function(a) {
        ...
        var FD = null,
            ...
            ZE = class extends _.lu {
                constructor(a) {
                    ...
                    this.pi = null;
                    this.Cm = b => {
                        b.target === this || this.Bk ? .contains(b.target) || JD(this)
                    };
                    this.ik = () => {
                    ...
                    this.rr = b => {
                        if (!b.isComposing)
                            if (b.key === "Enter") this.ph !== -1 ? (b.preventDefault(), b.stopPropagation(), $qa(this)) : (JD(this), this.ci.form ? .requestSubmit());
                            else if (b.key === "Escape" || b.key === "Esc") b.stopPropagation(),
                            LD(this, -1), JD(this);
                    ...
                    _.Ut((0, _.Q)
                        `<svg width="25" height="24" fill="none" viewBox="0 0 25 24"><path fill="#5e5e5e" fill-rule="evenodd" d="M15.56 13.27 21.29 19l-1.49 1.49-5.73-5.73A6.4 6.4 0 0110.3 16a6.5 6.5 0 116.5-6.5c0 1.41-.47 2.7-1.24 3.77M10.3 5a4.5 4.5 0 10-.01 8.99A4.5 4.5 0 0010.3 5" clip-rule="evenodd"/></svg>`, this.Ik);
                    bra(this);
                    dra(this);
                    this.Ph.classList.add("input-container");
                    this.Ph.append(this.Ik, this.Ah, this.mh, this.Hh, this.th);
                    this.oh.id = _.to();
                    this.oh.setAttribute("role",
                        "listbox");
                ...
                set noInputIcon(a) {
                    this.lk = !!this.Jh("noInputIcon", _.dt, a)
                }
            };
        ZE.formAssociated = !0;
        ZE.styles = [Fua];
        _.A([_.tr({
            type: String,
            Kh: !0
        }), _.B("design:type", Object), _.B("design:paramtypes", [Object])], ZE.prototype, "name", null);
        _.A([_.tr({
            type: Boolean,
            Kh: !0,
            Ih: "no-input-icon"
        }), _.B("design:type", Object), _.B("design:paramtypes", [Object])], ZE.prototype, "noInputIcon", null);
        var $E = class extends _.lu {
            constructor(a = {}) {
                super(a)
            }
            Oj(a) {
                ...
                a instanceof Object && a.eu instanceof Object && typeof a.eu.jz === "function" && this.parentElement.eu.jz()
            }
        };
        var aF = class {
            constructor(a) {
                this.host = a;
                this.CG = new MutationObserver(b => {
                    for (const c of b)
            ...
            jz() {
                var a = [];
                for (const b of Array.from(this.host.children)) this.host.Ux.has(b.constructor) ? a.push(b) : _.lq(this.host, `contains unrecognized config element <${b.tagName.toLowerCase()}>.`);
                a = jra(a).map(b => ({
                    Jv: b.constructor,
                    data: b.mh()
                }));
  ...
  `: mra(this.rating)
        ...
        bF.styles = _.Xt([".icons{display:-webkit-inline-box;display:-webkit-inline-flex;display:-moz-inline-box;display:-ms-inline-flexbox;display:inline-flex;height:1em}.icons.single-star{width:1em}.icons svg{-webkit-box-flex:1;-webkit-flex:1 1 50%;-moz-box-flex:1;-ms-flex:1 1 50%;flex:1 1 50%;height:100%}.icons svg:dir(rtl){-webkit-transform:scaleX(-1);transform:scaleX(-1)}.icons svg.star-filled{color:var(--gmp-star-rating-color,light-dark(#ffbb29,#ffbb29))}.icons svg.star-empty{color:var(--gmp-mat-color-disabled-surface,light-dark(#e3e3e3,#303030))}.icons svg.half-star-right{padding-right:2px}"]);
        _.A([_.tr({
            Ih: !1
        }), _.B("design:type", Number)], bF.prototype, "rating", void 0);
        _.A([_.tr({
            Ih: !1
        }), _.B("design:type", Object)], bF.prototype, "singleStar", void 0);
        _.zp("gmp-internal-rating", bF);
        var Bsa = class extends _.dv {
                ph() {
                    return Wqa
                }
                oh() {
            ...
            oE, Gua = [];
        _.Ra(ND, _.fo);
        ND.prototype.setTypes = _.Go("types", _.bn(_.$r));
        ND.prototype.setTypes = ND.prototype.setTypes;
        ND.prototype.setComponentRestrictions = _.Go("componentRestrictions", _.hn(_.Ym({
            country: _.fn([_.$r, _.bn(_.$r)])
        }, !0)));
        ND.prototype.setComponentRestrictions = ND.prototype.setComponentRestrictions;
        _.Ho(ND.prototype, {
            place: null,
            bounds: _.hn(_.Ao),
            fields: _.hn(DD)
        });
        OD.prototype.getPlacePredictions = function(a, b) {
            _.N(window, 154333);
            a = Hua(a);
        ...
        OD.prototype.getPlacePredictions = OD.prototype.getPlacePredictions;
        OD.prototype.getPredictions = OD.prototype.getPlacePredictions;
        OD.prototype.getQueryPredictions = function(a, b) {
            _.N(window, 154334);
            _.Wl("places_impl").then(() => {
                this.mh.getQueryPredictions(a, b)
            })
        };
        OD.prototype.getQueryPredictions = OD.prototype.getQueryPredictions;
        var Hua = _.Ym({
            language: _.ct,
            region: _.ct,
            sessionToken: _.hn(_.$m(_.Nu, "AutocompleteSessionToken")),
        ...
        cF.prototype.findPlaceFromPhoneNumber = cF.prototype.findPlaceFromPhoneNumber;
        cF.prototype.findPlaceFromQuery = cF.prototype.findPlaceFromQuery;
        cF.prototype.textSearch = cF.prototype.textSearch;
        cF.prototype.nearbySearch = cF.prototype.nearbySearch;
        cF.prototype.getDetails = cF.prototype.getDetails;
        ...
        dF.prototype.setBounds = dF.prototype.setBounds;
        dF.prototype.getBounds = dF.prototype.getBounds;
        dF.prototype.getPlaces = dF.prototype.getPlaces;
        _.Ho(dF.prototype, {
            places: null,
            bounds: _.hn(_.Ao)
        });
        var nE = class extends $E {
            constructor(a = {}) {
                super(a);
                this.zi(a, nE, "PlaceAllContentElement")
            }
            mh() {
                return {}
            }
        };
        nE.prototype.constructor = nE.prototype.constructor;
        nE.Hi = {
            Ki: 253442,
            Ji: 253422
        };
        _.zp("gmp-place-all-content", nE);
        var eF = {
                SMALL: "SMALL",
                MEDIUM: "MEDIUM",
                LARGE: "LARGE"
        ...
        var hF = class extends gF {
            constructor(a = {}) {
                super(a);
                this.zi(a, hF, "PlaceAccessibleEntranceIconElement")
            }
            mh() {
                return {}
            }
  ...
  <div class="default-button-content">
    ${(({ariaHidden:a,className:b})=>(0,_.Q)` < svg fill = "currentColor"
        ...
        viewBox = "0 -960 960 960" > & gt; < path d = "M480-160q-33 0-56.5-23.5T400-240t23.5-56.5T480-320t56.5 23.5T560-240t-23.5 56.5T480-160m0-240q-33 0-56.5-23.5T400-480t23.5-56.5T480-560t56.5 23.5T560-480t-23.5 56.5T480-400m0-240q-33 0-56.5-23.5T400-720t23.5-56.5T480-800t56.5 23.5T560-720t-23.5 56.5T480-640" / > < /svg>`)({ariaHidden:"true",className:"more"})} <
            /div>
        `,mF=class extends _.ku{constructor(){super(...arguments);this.menuItems=[];this.buttonTitle="Open menu";this.menuStyle="NORMAL";this.menuFont="LABEL_LARGE";this.mh=-1;this.oh=()=>{this.Qi.open?this.Qi.close():this.Qi.show()};this.qh=a=>{a.target?.focus()};this.ph=a=>{this.mh=Array.from(this.gC).indexOf(a.target)};this.rh=a=>{switch(a.key){case "Escape":this.Qi.close();this.button.focus();break;case "Tab":this.button.focus();break;case "ArrowDown":QD(this,1);break;case "ArrowUp":QD(this,-1);break;
case "Home":QD(this,-1E4);break;case "End":QD(this,1E4);break;default:return}a.stopPropagation();a.preventDefault()};this.nh=a=>{a=a.relatedTarget;!this.Qi.open||this.Qi.contains(a)||this.button.contains(a)||this.Qi.close()}}get open(){return this.Qi.open}oi(){return(0,_.Q)` <
        div
        class = $ {
                (0, _.Yr)({
                    container: !0,
        ...
        @focusout = $ {
            ...
            $ {
                ...
                <li role="presentation">
                  <a
                    ...
                    @focusin=${this.ph}
                    @mouseover=${this.qh}
                    ><span>${a.text}</span>${a.PR?_.Vr({ariaLabel:"",className:"open-in-new"}):""}</a
                  >
                </li>
              `)
            } <
            ...
            /dialog> <
            /div>
        `}};mF.styles=_.Xt([":host{position:relative}.container.lightbox{color-scheme:dark}button{background:none;border:none;font-size:inherit;-webkit-box-align:center;-webkit-align-items:center;-moz-box-align:center;-ms-flex-align:center;align-items:center;display:-webkit-box;display:-webkit-flex;display:-moz-box;display:-ms-flexbox;display:flex;-webkit-box-pack:center;-webkit-justify-content:center;-moz-box-pack:center;-ms-flex-pack:center;justify-content:center;min-height:48px;min-width:48px;padding:0}.container.lightbox button:focus-visible{border:none;outline:none}.container.lightbox button:focus-visible .default-button-content{border:2px solid #a8c7fa;border-radius:50%}button .default-button-content{-webkit-box-align:center;-webkit-align-items:center;-moz-box-align:center;-ms-flex-align:center;align-items:center;border-radius:50%;-moz-box-sizing:border-box;box-sizing:border-box;cursor:pointer;display:-webkit-box;display:-webkit-flex;display:-moz-box;display:-ms-flexbox;display:flex;height:40px;-webkit-box-pack:center;-webkit-justify-content:center;-moz-box-pack:center;-ms-flex-pack:center;justify-content:center;width:40px}.container.lightbox button .default-button-content{background-color:rgba(0,0,0,.8);color:#fff}.container.normal button .default-button-content{color:var(--gmp-mat-color-on-surface-variant,light-dark(#5e5e5e,#ababab))}.container.normal button .default-button-content:hover{background-color:color-mix(in srgb,transparent,var(--gmp-mat-color-on-surface-variant,light-dark(#5e5e5e,#ababab)) 8%)}button .default-button-content svg{width:18px}dialog{background:none;border:none;border-radius:8px;inset-inline:unset;overflow:hidden;padding:0;z-index:10}.container.normal dialog{box-shadow:0 1px 2px 0 color-mix(in srgb,transparent,var(--gmp-mat-color-on-surface,light-dark(#1f1f1f,#e3e3e3)) 30%),0 2px 6px 2px color-mix(in srgb,transparent,var(--gmp-mat-color-on-surface,light-dark(#1f1f1f,#e3e3e3)) 15%)}.container.lightbox dialog{box-shadow:0 1px 2px 0 rgba(0,0,0,.3)}dialog menu{list-style-type:none;margin:0;padding:0}.container.normal dialog menu li:not(:last-child){border-bottom:1px solid var(--gmp-mat-color-outline-decorative,light-dark(#e3e3e3,#474747))}dialog menu a{-webkit-box-align:center;-webkit-align-items:center;-moz-box-align:center;-ms-flex-align:center;align-items:center;-moz-box-sizing:border-box;box-sizing:border-box;display:-webkit-box;display:-webkit-flex;display:-moz-box;display:-ms-flexbox;display:flex;-webkit-box-orient:horizontal;-webkit-box-direction:normal;-webkit-flex-direction:row;-moz-box-orient:horizontal;-moz-box-direction:normal;-ms-flex-direction:row;flex-direction:row;font:var(--gmp-mat-font-label-large,normal 500 .875em/1.4285714286 var(--gmp-mat-font-family,Google Sans Text,sans-serif));gap:8px;height:48px;letter-spacing:.0071428571em;outline-offset:-2px;padding:var(--gmp-mat-spacing-large,16px);text-decoration:none}dialog menu a.body-medium{font:var(--gmp-mat-font-body-medium,normal 400 .875em/1.4285714286 var(--gmp-mat-font-family,Google Sans Text,sans-serif));letter-spacing:.0071428571em}.container.normal dialog menu a{background-color:var(--gmp-mat-color-surface,light-dark(#fff,#131314));color:var(--gmp-mat-color-on-surface,light-dark(#1f1f1f,#e3e3e3))}.container.normal dialog menu a:hover{background-color:color-mix(in srgb,var(--gmp-mat-color-surface,light-dark(#fff,#131314)),var(--gmp-mat-color-on-surface,light-dark(#1f1f1f,#e3e3e3)) 8%)}.container.normal dialog menu a:focus-visible{background-color:color-mix(in srgb,var(--gmp-mat-color-surface,light-dark(#fff,#131314)),var(--gmp-mat-color-on-surface,light-dark(#1f1f1f,#e3e3e3)) 10%)}.container.lightbox dialog menu a{background-color:rgba(0,0,0,.8);color:#fff}.container.lightbox dialog menu a:hover{text-decoration:underline}dialog menu a span{-webkit-box-flex:1;-webkit-flex:1;-moz-box-flex:1;-ms-flex:1;flex:1;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}dialog menu a svg{height:14px;width:14px}dialog menu a svg:dir(rtl){-webkit-transform:scaleX(-1);transform:scaleX(-1)}"]);
_.A([_.ur("button"),_.B("design:type",HTMLButtonElement)],mF.prototype,"button",void 0);_.A([_.ur("dialog"),_.B("design:type",HTMLDialogElement)],mF.prototype,"Qi",void 0);_.A([CD("menu a"),_.B("design:type",Object)],mF.prototype,"gC",void 0);_.A([_.tr({Ih:!1}),_.B("design:type",Array)],mF.prototype,"menuItems",void 0);_.A([_.tr({Ih:!1}),_.B("design:type",Object)],mF.prototype,"buttonTitle",void 0);_.A([_.tr({Ih:!1}),_.B("design:type",String)],mF.prototype,"menuStyle",void 0);
_.A([_.tr({Ih:!1}),_.B("design:type",String)],mF.prototype,"menuFont",void 0);_.zp("gmp-internal-menu",mF);var Uua=_.Xt([".open{color:var(--gmp-mat-color-positive,light-dark(#198639,#6dd58c))}.closed{color:var(--gmp-mat-color-negative,light-dark(#dc362e,#f2b8b5))}.expandable{all:unset;-webkit-box-align:center;-webkit-align-items:center;-moz-box-align:center;-ms-flex-align:center;align-items:center;cursor:pointer;display:-webkit-box;display:-webkit-flex;display:-moz-box;display:-ms-flexbox;display:flex;width:100%}.expandable:focus{outline:revert}.arrow{fill:var(--gmp-mat-color-on-surface-variant,light-dark(#5e5e5e,#ababab));-webkit-margin-start:var(--gmp-mat-spacing-extra-large,20px);-moz-margin-start:var(--gmp-mat-spacing-extra-large,20px);margin-inline-start:var(--gmp-mat-spacing-extra-large,20px);width:1.7142857143em}.weekly-hours{color:var(--gmp-mat-color-on-surface,light-dark(#1f1f1f,#e3e3e3));display:-webkit-box;display:-webkit-flex;display:-moz-box;display:-ms-flexbox;display:flex;-webkit-box-orient:vertical;-webkit-box-direction:normal;-webkit-flex-direction:column;-moz-box-orient:vertical;-moz-box-direction:normal;-ms-flex-direction:column;flex-direction:column;gap:var(--gmp-mat-spacing-medium,12px);list-style:none;margin-block:var(--gmp-mat-spacing-small,8px) 0;-webkit-margin-start:44px;-moz-margin-start:44px;margin-inline-start:44px;padding:0}.interpunct{margin:0 var(--gmp-mat-spacing-extra-small,4px)}"]);var UD=class{constructor(a){this.mh=a.hasWheelchairAccessibleEntrance??null;this.oh=a.hasWheelchairAccessibleRestroom??null;this.ph=a.hasWheelchairAccessibleSeating??null;this.nh=a.hasWheelchairAccessibleParking??null}get hasWheelchairAccessibleEntrance(){return this.mh}get hasWheelchairAccessibleRestroom(){return this.oh}get hasWheelchairAccessibleSeating(){return this.ph}get hasWheelchairAccessibleParking(){return this.nh}toJSON(){return{hasWheelchairAccessibleEntrance:this.mh,hasWheelchairAccessibleRestroom:this.oh,
hasWheelchairAccessibleSeating:this.ph,hasWheelchairAccessibleParking:this.nh}}};UD.prototype.toJSON=UD.prototype.toJSON;var xra=class{constructor(a){this.nh=_.Em(a.longText);this.oh=_.Em(a.shortText);this.mh=a.types||[]}get longText(){return this.nh}get shortText(){return this.oh}get types(){return this.mh}toJSON(){return{longText:this.longText,shortText:this.shortText,types:this.types.slice(0)}}};var Vua=class{constructor(a,b){this.nh=a;this.mh=b({id:a.place.id,displayName:a.place.displayName,displayNameLanguageCode:a.place.displayNameLanguageCode})}get place(){return this.mh}get containment(){return this.nh.containment}toJSON(){return{place:this.mh.Di,containment:this.nh.containment}}};var Wua=class{constructor(a,b){this.mh=a;this.nh=b({id:a.place.id,displayName:a.place.displayName,displayNameLanguageCode:a.place.displayNameLanguageCode,types:a.place.types})}get place(){return this.nh}get spatialRelationship(){return this.mh.spatialRelationship}get straightLineDistanceMeters(){return this.mh.straightLineDistanceMeters}get travelDistanceMeters(){return this.mh.travelDistanceMeters}toJSON(){return{place:this.nh.Di,spatialRelationship:this.mh.spatialRelationship,straightLineDistanceMeters:this.mh.straightLineDistanceMeters,
travelDistanceMeters:this.mh.travelDistanceMeters}}};var Jra=class{constructor(a,b){this.mh=a;this.oh=this.mh.landmarks?this.mh.landmarks.map(c=>new Wua(c,b)):[];this.nh=this.mh.areas?this.mh.areas.map(c=>new Vua(c,b)):[]}get landmarks(){return this.oh}get areas(){return this.nh}toJSON(){return{landmarks:this.mh.landmarks,areas:this.mh.areas}}};var yra=class{constructor(a){this.mh=_.Em(a.provider);this.nh=_.Em(a.providerURI)}get provider(){return this.mh}get providerURI(){return this.nh}toJSON(){return{provider:this.provider,providerURI:this.providerURI}}};var Xua=class{constructor(a){this.oh=(0,_.mn)(a.hour);this.mh=a.vA??null;this.nh=a.Jy?a.Jy:null;this.qh=a.PD??null;this.ph=a.bz?a.bz:null}get hour(){return this.oh}get vA(){return this.mh}get Jy(){return this.nh}get PD(){return this.qh}get bz(){return this.ph}toJSON(){return{hour:this.oh,vA:this.mh,Jy:this.nh,PD:this.qh,bz:this.ph}}};var Yua=class{constructor(a){this.mh=(0,_.mn)(a.GA);this.nh=(a.vB||[]).map(b=>new Xua(b));this.qh=a.hC??null;this.oh=a.eC??null;this.ph=a.fC??null}get GA(){return this.mh}get vB(){return this.nh}get hC(){return this.qh}get eC(){return this.oh}get fC(){return this.ph}toJSON(){return{GA:this.mh,vB:this.nh.map(a=>a.toJSON()),hC:this.qh,eC:this.oh,fC:this.ph}}};var Kra=class{constructor(a){this.mh=(a.EA||[]).map(b=>new Yua(b))}get EA(){return this.mh}toJSON(){return{EA:this.mh.map(a=>a.toJSON())}}};var zra=class{constructor(a){this.oh=a.overview;this.mh=a.details&&new nF(a.details);this.nh=a.languageCode}get overview(){return this.oh}get details(){return this.mh}get languageCode(){return this.nh}toJSON(){return{overview:this.oh,details:this.mh?.toJSON()??null,languageCode:this.nh}}},nF=class{constructor(a){this.ph=a.title;this.oh=a.description;this.mh=a.aboutLinkTitle;this.nh=a.aboutLinkURI}get title(){return this.ph}get description(){return this.oh}get aboutLinkTitle(){return this.mh}get aboutLinkURI(){return this.nh}toJSON(){return{title:this.ph,
description:this.oh,aboutLinkTitle:this.mh,aboutLinkURI:this.nh}}};nF.prototype.toJSON=nF.prototype.toJSON;var oF=class{constructor(a){this.mh={...a}}get flagContentURI(){return this.mh.flagContentURI??null}get disclosureText(){return this.mh.disclosureText??null}get disclosureTextLanguageCode(){return this.mh.disclosureTextLanguageCode??null}toJSON(){return{flagContentURI:this.flagContentURI,disclosureText:this.disclosureText,disclosureTextLanguageCode:this.disclosureTextLanguageCode}}};var pF=class{constructor(a,b){this.mh=a.content??null;this.nh=a.contentLanguageCode??null;this.oh=a.referencedPlaces?a.referencedPlaces.map(c=>b({id:c})):[]}get content(){return this.mh}get contentLanguageCode(){return this.nh}get referencedPlaces(){return this.oh}toJSON(){return{content:this.content,contentLanguageCode:this.contentLanguageCode,referencedPlaces:this.referencedPlaces.map(a=>a.id)}}};var VD=class extends oF{constructor(a,b){super(a);this.nh=a.overview?new pF(a.overview,b):null;this.oh=a.coffee?new pF(a.coffee,b):null;this.ph=a.restaurant?new pF(a.restaurant,b):null;this.qh=a.store?new pF(a.store,b):null}get overview(){return this.nh}get coffee(){return this.oh}get restaurant(){return this.ph}get store(){return this.qh}toJSON(){return{...super.toJSON(),overview:this.overview?.toJSON()??null,coffee:this.coffee?.toJSON()??null,restaurant:this.restaurant?.toJSON()??null,store:this.store?.toJSON()??
null}}};var Ara=class{constructor(a){this.nh=a.connectorCount;this.mh=(a.connectorAggregations??[]).map(b=>new qF(b))}get connectorCount(){return this.nh}get connectorAggregations(){return this.mh}toJSON(){return{connectorCount:this.nh,connectorAggregations:this.mh.map(a=>a.toJSON())}}},qF=class{constructor(a){this.mh=a.type;this.qh=a.maxChargeRateKw;this.ph=a.count;this.oh=AD(a.availableCount);this.rh=AD(a.outOfServiceCount);this.nh=a.availabilityLastUpdateTime?new Date(a.availabilityLastUpdateTime):null}get type(){return this.mh}get maxChargeRateKw(){return this.qh}get count(){return this.ph}get availableCount(){return this.oh}get outOfServiceCount(){return this.rh}get availabilityLastUpdateTime(){return this.nh}toJSON(){return{type:this.mh,
maxChargeRateKw:this.qh,count:this.ph,availableCount:this.oh,outOfServiceCount:this.rh,availabilityLastUpdateTime:this.nh?.toISOString()??null}}};qF.prototype.toJSON=qF.prototype.toJSON;var Bra=class{constructor(a,b={}){this.mh=(a.fuelPrices??[]).map(c=>new rF(c,b))}get fuelPrices(){return this.mh}toJSON(){return{fuelPrices:this.mh.map(a=>a.toJSON())}}},rF=class{constructor(a,b={}){this.mh=a.type;this.nh=a.price?new _.Pu(a.price,b):null;this.oh=a.updateTime?new Date(a.updateTime):null}get type(){return this.mh}get price(){return this.nh}get updateTime(){return this.oh}toJSON(){return{type:this.mh,price:this.nh?.toJSON()??null,updateTime:this.oh?.toISOString()??null}}};
rF.prototype.toJSON=rF.prototype.toJSON;var Dra=class extends oF{constructor(a){super(a);this.mh={...a}}get overview(){return this.mh.overview??null}get overviewLanguageCode(){return this.mh.overviewLanguageCode??null}toJSON(){return{...super.toJSON(),overview:this.overview,overviewLanguageCode:this.overviewLanguageCode}}};var Era=class{constructor(a){this.mh=a.directionsURI;this.oh=a.placeURI;this.qh=a.writeAReviewURI;this.ph=a.reviewsURI;this.nh=a.photosURI}get directionsURI(){return this.mh}get placeURI(){return this.oh}get writeAReviewURI(){return this.qh}get reviewsURI(){return this.ph}get photosURI(){return this.nh}toJSON(){return{directionsURI:this.mh,placeURI:this.oh,writeAReviewURI:this.qh,reviewsURI:this.ph,photosURI:this.nh}}};var Cra=class extends oF{constructor(a,b){super(a);this.nh=a.overview?new pF(a.overview,b):null;this.oh=a.description?new pF(a.description,b):null}get overview(){return this.nh}get description(){return this.oh}toJSON(){return{...super.toJSON(),overview:this.overview?.toJSON()??null,description:this.description?.toJSON()??null}}};var sF=class{constructor(a){this.nh=(0,_.mn)(a.day);this.oh=(0,_.mn)(a.hour);this.ph=(0,_.mn)(a.minute)}get day(){return this.nh}get hour(){return this.oh}get minute(){return this.ph}toJSON(){return{day:this.day,hour:this.hour,minute:this.minute}}mh(a,b){const c=new Date(a);b=(this.day+7)*24*60+this.hour*60+this.minute-b;const d=Math.floor(b/1440)%7,e=b%60;c.setUTCHours(Math.floor(b/60)%24);c.setUTCMinutes(e);c.setUTCMilliseconds(0);c.setUTCSeconds(0);c.setUTCDate(c.getUTCDate()+(d-c.getUTCDay()));
c.getTime()<a&&c.setUTCDate(c.getUTCDate()+7);return c.getTime()}};var Zua=class{constructor(a){this.mh=a.close?new sF(a.close):null;this.nh=_.jn("open")(a)&&new sF(a.open)}get close(){return this.mh}get open(){return this.nh}toJSON(){const a={open:this.open.toJSON()};this.close&&(a.close=this.close.toJSON());return a}};var WD=class{constructor(a){this.nh=a.periods?a.periods.map(b=>new Zua(b)):[];this.ph=a.weekdayDescriptions||[];this.oh=a.specialDays?a.specialDays.map(b=>new Date(b)):[]}get periods(){return this.nh}get weekdayDescriptions(){return this.ph}get specialDays(){return this.oh}toJSON(){return{periods:this.periods.map(a=>a.toJSON()),weekdayDescriptions:this.weekdayDescriptions.slice(0),specialDays:this.specialDays.map(a=>a.toJSON())}}};var YD=class{constructor(a){this.nh=a.hasFreeParkingLot??null;this.qh=a.hasPaidParkingLot??null;this.oh=a.hasFreeStreetParking??null;this.rh=a.hasPaidStreetParking??null;this.sh=a.hasValetParking??null;this.mh=a.hasFreeGarageParking??null;this.ph=a.hasPaidGarageParking??null}get hasFreeParkingLot(){return this.nh}get hasPaidParkingLot(){return this.qh}get hasFreeStreetParking(){return this.oh}get hasPaidStreetParking(){return this.rh}get hasValetParking(){return this.sh}get hasFreeGarageParking(){return this.mh}get hasPaidGarageParking(){return this.ph}toJSON(){return{hasFreeParkingLot:this.nh,
hasPaidParkingLot:this.qh,hasFreeStreetParking:this.oh,hasPaidStreetParking:this.rh,hasValetParking:this.sh,hasFreeGarageParking:this.mh,hasPaidGarageParking:this.ph}}};YD.prototype.toJSON=YD.prototype.toJSON;var ZD=class{constructor(a){this.nh=a.acceptsCreditCards??null;this.oh=a.acceptsDebitCards??null;this.mh=a.acceptsCashOnly??null;this.ph=a.acceptsNfc??null}get acceptsCreditCards(){return this.nh}get acceptsDebitCards(){return this.oh}get acceptsCashOnly(){return this.mh}get acceptsNFC(){return this.ph}toJSON(){return{acceptsCreditCards:this.nh,acceptsDebitCards:this.oh,acceptsCashOnly:this.mh,acceptsNfc:this.ph}}};ZD.prototype.toJSON=ZD.prototype.toJSON;var tF=class{constructor(a){this.mh=(0,_.$r)(a.displayName);this.nh=_.Em(a.photoURI);this.oh=_.Em(a.uri)}get displayName(){return this.mh}get uri(){return this.oh}get photoURI(){return this.nh}toJSON(){return{displayName:this.displayName,uri:this.uri,photoURI:this.photoURI}}};var $D=class{constructor(a){this.ph=a.authorAttributions?a.authorAttributions.map(b=>new tF(b)):[];this.rh=(0,_.mn)(a.heightPx);this.qh=a.getUrl&&(0,_.Nfa)(a.getUrl);this.sh=(0,_.mn)(a.widthPx);this.mh=(0,_.ct)(a.name);this.nh=(0,_.ct)(a.flagContentURI)??null;this.oh=(0,_.ct)(a.googleMapsURI)??null}get authorAttributions(){return this.ph}get heightPx(){return this.rh}get widthPx(){return this.sh}get name(){return this.mh}getURI(a={}){let b=a.maxWidth,c=a.maxHeight;b||c||(b=this.widthPx);b&&(b=Math.max(b,
...
$D.prototype.getURI = $D.prototype.getURI;
var eta = new Map([
    ...
    $ua = new Set(["busyness"]),
    uF = Object.freeze(Array.from(eta.keys())),
    xE = Object.freeze(uF.filter(a =>
        !$ua.has(a)));
var ava = class extends _.Ou {
    constructor() {
        super(...arguments);
        this.requestedRegion = this.requestedLanguage = null;
        this.Di = {};
        this.wh = this.Ah = this.yh = this.pi = this.xi = this.ci = this.Ch = this.Nh = this.Hh = this.zh = this.Lh = this.th = this.sh = this.mi = this.Xh = this.rh = this.qh = this.Vh = this.Qh = this.Ph = this.Gh = this.Fh = this.Bh = this.Zh = this.mh = this.nh = this.ph = this.xh = this.oh = this.uh = void 0
    }
    ...
    get googleMapsURI() {
        return this.Di.googleMapsURI ?
            _.Mea(new URL(this.Di.googleMapsURI), {
...
var Gra = class {
    constructor(a, b = {}) {
        this.nh = new _.Pu(a.startPrice, b);
        this.mh = a.endPrice ? new _.Pu(a.endPrice, b) : null
    }
    get startPrice() {
        return this.nh
    }
...
var aE = class {
    constructor(a) {
        this.ph = a.authorAttribution ? new tF(a.authorAttribution) : null;
        this.mh = a.publishTime ? new Date(a.publishTime) : null;
        this.th = _.Em(a.relativePublishTimeDescription);
        this.sh = AD(a.rating);
        this.yh = AD(a.visitDateYear);
        this.xh = AD(a.visitDateMonth);
        this.uh = _.Em(a.text);
...
var XD = class extends WD {
    constructor(a) {
        super(a);
        this.mh = a.type ? vra(cva.get(a.type) ? ? null) : null
    }
    get type() {
        return this.mh
    }
...
var eE = class extends _.ku {
    ...
    Oj() {
        clearTimeout(this.mh);
        this.place && (this.mh = setTimeout(() => void _.dq(this), 6E4))
    }
    oi() {
        var a = Qra(this);
        if (!a) return null;
      ...
      <button
        class="expandable"
        @click="${()=>{this.wu=!this.wu}}"
        aria-controls="weekly-hours"
        aria-expanded="${this.wu}">
        <slot name="prefix"></slot>${a}
        ${Oua({ariaLabel:"Show open hours for the week",transform:this.wu?"scale(1, -1)":""})}
      </button>
      ${this.wu?Sra(this):null}
    `: a
    }
};
eE.mh = new Set(["businessStatus", "regularOpeningHours", "utcOffsetMinutes"]);
eE.styles = Uua;
_.A([_.vr(), _.B("design:type", Object)], eE.prototype, "wu", void 0);
_.A([_.tr({
    Ih: !1
}), _.B("design:type", Object)], eE.prototype, "isExpandable", void 0);
_.A([_.tr({
    Ih: !1
}), _.B("design:type", TE)], eE.prototype, "place", void 0);
_.zp("gmp-internal-place-opening-hours", eE);
var vF = class extends _.ku {
    constructor() {
        super(...arguments);
        this.ix = !1
    }
    oi() {
      ...
      <div class="review">
        ...
        ${this.review.visitDateYear!=null&&this.review.visitDateMonth!=null?(0,_.Q)`<div class="date-visited-text">
              ${BD("Visited {date}",{date:_.wea(new Date(this.review.visitDateYear,this.review.visitDateMonth))})}
            </div> `:_.Pt}
        ${c?Ura(this,b):_.Pt}
      </div>
    `
...
var dva = (({
    ...
    xF = class extends _.ku {
        constructor() {
            ...
            this.ph = a => {
                navigator.maxTouchPoints < 2 && window.screen.width > 640 || (this.qh = a.touches[0].screenX, this.rh = a.touches[0].screenY, a.stopPropagation())
            };
            this.oh = a => {
      ...
      <a
        ...
        aria-label=${b.uri?_.Pr(b.displayName):_.Pt}
        href=${b.uri??void 0??_.Pt}
        target="_blank">
        <div class="info-card">
          <div class="author-attribution sub">
            ${b.photoURI?(0,_.sia)(b.photoURI,(0,_.Q)` <img
    ...
    `;
      ...
      <div class="control-card">
        ...
        <button
          ...
          @click=${this.close}>
          <div class="circle-button-svg-container">${eva}</div>
        </button>
      </div>
      ...
      <div class="nav-card">
        <div class="nav-controls">
          <button
            ...
            @click=${this.nh}>
            <div class="circle-button-svg-container">${dva}</div>
          </button>
          <button
    ...
    `;
            ...
            return (0, _.Q)
            ` <dialog class="lightbox" @keydown=${this.th}>
      ${(0,_.sia)(a.nu,this.open?(0,_.Q)` <div
                  class="backdrop"
      ...
      ${f}
        ...
        Oj() {
            if (this.open)
                for (const a of [this.photoDisplayDataList[this.currentPhotoIndex + 1] ? .Hu, this.photoDisplayDataList[this.currentPhotoIndex + 1] ? .nu, this.photoDisplayDataList[this.currentPhotoIndex - 1] ? .Hu, this.photoDisplayDataList[this.currentPhotoIndex - 1] ? .nu]) a && ((new Image).src = a)
        }
        Ij() {
...
xF.styles = Sua;
_.A([_.ur("dialog"), _.B("design:type", HTMLDialogElement)], xF.prototype, "Qi", void 0);
_.A([_.ur("gmp-internal-menu"), _.B("design:type", mF)], xF.prototype, "lI", void 0);
_.A([_.tr({
    Ih: !1
}), _.B("design:type", Array)], xF.prototype, "photoDisplayDataList", void 0);
_.A([_.tr({
    Ih: !1
}), _.B("design:type", Object)], xF.prototype, "currentPhotoIndex", void 0);
_.A([_.vr(), _.B("design:type", Object)], xF.prototype, "mz", void 0);
_.zp("gmp-internal-lightbox", xF);
var Vra = (({
            className: a
        }) => (0, _.Q)
    ...
    yF = class extends _.ku {
        ...
        qr(a) {
            a.has("photoDisplayDataList") && (this.mh = this.photoDisplayDataList.map(b => {
                var c = b.uri;
                let d, e;
                c.includes("googleusercontent.com") ? (e = hE(c, {
        ...
        Oj() {
            if (this.requestStatus === "SUCCESS" &&
                ...
                for (let a = 0; a < this.mI.length; a++) {
...
var zF = class extends gF {
    ...
    constructor(a = {}) {
        ...
        this.nh = !1;
        this.oh = null;
        this.zi(a, zF, "PlaceMediaElement");
...
zF.styles = [...gF.styles, gva];
_.A([_.tr({
    Ih: "lightbox-preferred",
    type: Boolean,
    Kh: !0
}), _.B("design:type", Object), _.B("design:paramtypes", [Object])], zF.prototype, "lightboxPreferred", null);
_.A([_.tr({
    Ih: "preferred-size",
    ii: _.yp(eF),
    Kh: !0
}), _.B("design:type", Object), _.B("design:paramtypes", [Object])], zF.prototype, "preferredSize", null);
var hva = _.Xt(["span{color:var(--gmp-mat-color-on-surface-variant,light-dark(#5e5e5e,#ababab))}.font-size--small{font:var(--gmp-mat-font-body-small,normal 400 .75em/1.3333333333 var(--gmp-mat-font-family,Google Sans Text,sans-serif));letter-spacing:.0166666667em}.font-size--medium{font:var(--gmp-mat-font-body-medium,normal 400 .875em/1.4285714286 var(--gmp-mat-font-family,Google Sans Text,sans-serif));letter-spacing:.0071428571em}"]);
var AF = class extends gF {
    constructor(a = {}) {
        super(a);
        this.zi(a, AF, "PlaceOpenNowStatusElement")
    }
    mh() {
        return {}
    }
...
AF.styles = [...gF.styles, hva];
var iva = _.Xt(["gmp-internal-place-opening-hours{color:var(--gmp-mat-color-on-surface,light-dark(#1f1f1f,#e3e3e3));padding:var(--gmp-mat-spacing-medium,12px) var(--gmp-mat-spacing-extra-large,20px)}gmp-internal-place-opening-hours svg{color:var(--gmp-mat-color-primary,light-dark(#007b8b,#58b9ca));-webkit-flex-shrink:0;-ms-flex-negative:0;flex-shrink:0;-webkit-margin-end:var(--gmp-mat-spacing-extra-large,20px);-moz-margin-end:var(--gmp-mat-spacing-extra-large,20px);margin-inline-end:var(--gmp-mat-spacing-extra-large,20px);width:var(--gmp-mat-spacing-two-extra-large,24px)}"]);
var BF = class extends gF {
    constructor(a = {}) {
        super(a);
        this.zi(a, BF, "PlaceOpeningHoursElement")
    }
    mh() {
        return {}
    }
...
CF.styles = [...gF.styles, jva];
var kva = _.Xt([".contacts-row{-webkit-box-align:center;-webkit-align-items:center;-moz-box-align:center;-ms-flex-align:center;align-items:center;color:var(--gmp-mat-color-on-surface,light-dark(#1f1f1f,#e3e3e3));display:-webkit-box;display:-webkit-flex;display:-moz-box;display:-ms-flexbox;display:flex;padding:var(--gmp-mat-spacing-medium,12px) var(--gmp-mat-spacing-extra-large,20px)}.contacts-row svg{color:var(--gmp-mat-color-primary,light-dark(#007b8b,#58b9ca));-webkit-flex-shrink:0;-ms-flex-negative:0;flex-shrink:0;-webkit-margin-end:var(--gmp-mat-spacing-extra-large,20px);-moz-margin-end:var(--gmp-mat-spacing-extra-large,20px);margin-inline-end:var(--gmp-mat-spacing-extra-large,20px);width:var(--gmp-mat-spacing-two-extra-large,24px)}"]);
var DF = class extends gF {
    constructor(a = {}) {
        super(a);
        this.zi(a, DF, "PlacePlusCodeElement")
    }
    mh() {
        return {}
    }
...
DF.styles = [...gF.styles, kva];
var lva = _.Xt(["span{color:var(--gmp-mat-color-on-surface-variant,light-dark(#5e5e5e,#ababab))}.font-size--small{font:var(--gmp-mat-font-body-small,normal 400 .75em/1.3333333333 var(--gmp-mat-font-family,Google Sans Text,sans-serif));letter-spacing:.0166666667em}.font-size--medium{font:var(--gmp-mat-font-body-medium,normal 400 .875em/1.4285714286 var(--gmp-mat-font-family,Google Sans Text,sans-serif));letter-spacing:.0071428571em}"]);
var EF = class extends gF {
    constructor(a = {}) {
        super(a);
        this.zi(a, EF, "PlacePriceElement")
    }
    mh() {
        return {}
    }
...
EF.styles = [...gF.styles, lva];
var mva = "administrative_area_level_1 administrative_area_level_2 country locality natural_feature route street_address".split(" "),
    FF = class extends _.ku {
        constructor() {
            super(...arguments);
            this.Sy = this.infoButtonShown = !1
        }
        oi() {
            ...
            var b = this.place.userRatingCount,
                ...
                d = this.place.types;
            if (a == null || b == null || b === 0) return d ? .some(e => mva.includes(e)) ? "" : (0, _.Q)
            `<div class="container">
        <span>${"No reviews"}</span>
            ...
            d = BD("{STAR_RATING, plural,\n     =1 {# star out of 5 stars}\n     other {# stars out of 5 stars}}", {
                STAR_RATING: a
            });
            c = gsa(this.place, c ? ? void 0, this.stopPropagation);
            return (0, _.Q)
            `
      ...
      <div class="info-button-container">
        <button
          ...
          aria-expanded=${this.Sy}
          aria-label=${"About ratings"}
          title=${"About ratings"}
          aria-describedby=${(this.Sy?"disclosure-popover":void 0)??_.Pt}>
          <div class="tap-area"></div>
          <div class="info-icon-container">${_.mea({fill:"light-dark(#5e5e5e, #fff)"})}</div>
        </button>
        <div
...
var IF = class extends gF {
    constructor(a = {}) {
        super(a);
        this.zi(a, IF, "PlaceReviewsElement")
    }
    mh() {
        return {}
    }
...
JF.styles = [...gF.styles, qva];
var rva = _.Xt(["span{color:var(--gmp-mat-color-on-surface-variant,light-dark(#5e5e5e,#ababab))}.font-size--small{font:var(--gmp-mat-font-body-small,normal 400 .75em/1.3333333333 var(--gmp-mat-font-family,Google Sans Text,sans-serif));letter-spacing:.0166666667em}.font-size--medium{font:var(--gmp-mat-font-body-medium,normal 400 .875em/1.4285714286 var(--gmp-mat-font-family,Google Sans Text,sans-serif));letter-spacing:.0071428571em}"]);
var KF = class extends gF {
    constructor(a = {}) {
        super(a);
        this.zi(a, KF, "PlaceTypeElement")
    }
    mh() {
        return {}
    }
...
LF.styles = [...gF.styles, sva];
var tva = _.Xt([".website-link{-webkit-box-align:center;-webkit-align-items:center;-moz-box-align:center;-ms-flex-align:center;align-items:center;color:var(--gmp-mat-color-primary,light-dark(#007b8b,#58b9ca));display:-webkit-box;display:-webkit-flex;display:-moz-box;display:-ms-flexbox;display:flex;padding:var(--gmp-mat-spacing-medium,12px) var(--gmp-mat-spacing-extra-large,20px)}.website-link svg{-webkit-flex-shrink:0;-ms-flex-negative:0;flex-shrink:0;-webkit-margin-end:var(--gmp-mat-spacing-extra-large,20px);-moz-margin-end:var(--gmp-mat-spacing-extra-large,20px);margin-inline-end:var(--gmp-mat-spacing-extra-large,20px);width:var(--gmp-mat-spacing-two-extra-large,24px)}"]);
var MF = class extends gF {
    constructor(a = {}) {
        super(a);
        this.zi(a, MF, "PlaceWebsiteElement")
    }
    mh() {
        return {}
    }
...
MF.styles = [...gF.styles, tva];
var NF = class extends $E {
    set lightSchemeColor(a) {
        this.oh = this.Jh("lightSchemeColor", _.hn(_.an(fF)), a) || "GRAY"
    }
    get lightSchemeColor() {
        return this.oh
    }
    set darkSchemeColor(a) {
        this.nh = this.Jh("darkSchemeColor", _.hn(_.an(fF)), a) || "WHITE"
    }
    get darkSchemeColor() {
        return this.nh
    }
    constructor(a = {}) {
        ...
        this.oh = "GRAY";
        this.nh = "WHITE";
        this.zi(a, NF, "PlaceAttributionElement");
...
NF.prototype.constructor = NF.prototype.constructor;
NF.Hi = {
    Ki: 253450,
    Ji: 253430
};
_.A([_.tr({
    ...
    ii: _.yp(fF),
    Kh: !0
}), _.B("design:type", Object), _.B("design:paramtypes", [Object])], NF.prototype, "lightSchemeColor", null);
_.A([_.tr({
    Ih: "dark-scheme-color",
    ii: _.yp(fF),
    Kh: !0
}), _.B("design:type", Object), _.B("design:paramtypes", [Object])], NF.prototype, "darkSchemeColor", null);
var rsa = new Map([
        ["gmp-place-media", zF],
        ["gmp-place-address", iF],
        ["gmp-place-rating", GF],
        ["gmp-place-type", KF],
        ["gmp-place-price", EF],
        ["gmp-place-accessible-entrance-icon", hF],
        ["gmp-place-open-now-status", AF],
        ["gmp-place-attribution", NF]
    ]),
    ssa = new Map([
        ["gmp-place-website", MF],
        ["gmp-place-phone-number", CF],
        ["gmp-place-opening-hours", BF],
        ["gmp-place-summary", JF],
        ["gmp-place-type-specific-highlights", LF],
        ["gmp-place-review-summary", HF],
        ["gmp-place-reviews", IF],
        ["gmp-place-plus-code", DF],
...
[...ssa];
var uva = [
        [zF, "media", "PlaceMediaElement"],
        [iF, "address", "PlaceAddressElement"],
        [GF, "rating", "PlaceRatingElement"],
        [KF, "placeType", "PlaceTypeElement"],
        [EF, "price", "PlacePriceElement"],
        [hF, "accessibleEntranceIcon", "PlaceAccessibleEntranceIconElement"],
        [AF, "openNowStatus", "PlaceOpenNowStatusElement"],
        [NF, "attribution", "PlaceAttributionElement"],
        [MF, "website", "PlaceWebsiteElement"],
        [CF, "phoneNumber", "PlacePhoneNumberElement"],
        [BF, "openingHours", "PlaceOpeningHoursElement"],
        [JF, "summary", "PlaceSummaryElement"],
        [LF, "typeSpecificHighlights", "PlaceTypeSpecificHighlightsElement"],
        [HF, "reviewSummary", "PlaceReviewSummaryElement"],
        [IF, "reviews", "PlaceReviewsElement"],
        [DF, "plusCode", "PlacePlusCodeElement"],
        [jF, "featureList", "PlaceFeatureListElement"]
    ],
    vva = new Map(uva.map(([a, b]) => [a, b])),
    ysa = new Map(uva.map(([, a, b]) => [a, b])),
    CE = {
        media: {
            lightboxPreferred: !1,
            preferredSize: "SMALL"
    ...
    lE = class extends $E {
        constructor(a = {}) {
            super(a);
            this.eu = new aF(this);
            this.Ux = new Set([zF, iF, GF, KF, EF, hF, AF, NF, MF, CF, BF, JF, LF, IF, HF, DF, jF]);
            this.ek = {};
            this.zi(a, lE, "PlaceContentConfigElement")
        }
        mh() {
            return this.ek
        }
        tv(a) {
            ...
            for (const {
                    Jv: c,
                    data: d
                } of a)(a = vva.get(c)) ? a === "media" ? b.media = d : a === "attribution" ? b.attribution = d : b[a] = d : console.error(`Unknown element constructor: ${c}`,
                c);
            return b
        }
    };
...
_.A([_.vr({
    ij: (a, b) => !kE(a, b)
}), _.B("design:type", Object)], lE.prototype, "ek", void 0);
_.zp("gmp-place-content-config", lE);
var mE = class extends $E {
    constructor(a = {}) {
        super(a);
        this.zi(a, mE, "PlaceStandardContentElement")
    }
    mh() {
        return {}
    }
...
_.zp("gmp-place-standard-content", mE);
var OF = {
    HORIZONTAL: "HORIZONTAL",
    VERTICAL: "VERTICAL"
};
var PF = class extends _.ku {
    constructor() {
        super(...arguments);
        this.titleSize = "medium";
        this.fontSize = "small";
        this.ratingInfoButtonShown = this.addressEnabled = !1;
        this.contentConfig = CE;
    ...
    >` : null, this.addressEnabled && this.contentConfig.address && this.place ? .formattedAddress ? (0, _.Q)
            ...
            b = [this.contentConfig.rating ? (0, _.Q)
                `<gmp-internal-place-rating-summary
      .place=${this.place}
      .starVariant=${this.ratingVariant??_.Pt}
      .infoButtonShown=${this.ratingInfoButtonShown}>
    </gmp-internal-place-rating-summary>` : null, this.place ? wsa(this.place, {
                    contentConfig: this.contentConfig,
                    slottedElements: this.slottedElements
                }) : null, this.contentConfig.openNowStatus && Pra(this.place) ? (0, _.Q)
...
var RF = class extends $E {
    ...
    constructor(a = {}) {
        ...
        this.zi(a, RF, "PlaceDetailsLocationRequestElement")
    }
    mh() {
...
RF.prototype.constructor = RF.prototype.constructor;
RF.Hi = {
    Ki: 222488,
    Ji: 222486
};
_.A([_.tr({
    ...
    ij: _.Wp,
    Kh: !0
}), _.B("design:type", Object), _.B("design:paramtypes", [Object])], RF.prototype, "location", null);
_.zp("gmp-place-details-location-request", RF);
var Qsa = new Map([
        [1, "FREE"],
        [2, "INEXPENSIVE"],
        [3, "MODERATE"],
    ...
    Zsa = new Map([
        [1, "QUIET"],
        [2, "NOT_BUSY_NOT_QUIET"],
        [3, "LITTLE_BUSY"],
        [4, "AS_BUSY_AS_EVER"]
    ]),
    $sa = new Map([
        [1, "LESS_BUSY_THAN_USUAL"],
        [2, "NOT_BUSY"],
        [3, "NOT_TOO_BUSY"],
        [4, "A_LITTLE_BUSY"],
        [5, "BUSY"],
        [6, "BUSIER_THAN_USUAL"],
        [7, "WAY_MORE_PEOPLE_THAN_USUAL"],
        [8, "AS_BUSY_AS_IT_GETS"]
    ]),
    cta = new Map([
        [1, "WITHIN"],
        [2, "OUTSKIRTS"],
...
var uE = _.bn(_.et),
    ...
    jta = _.Ym({
        ...
        textQuery: _.hn(_.et),
        language: _.ct,
        locationBias: _.hn(ita),
        locationRestriction: _.hn(hta),
        priceLevels: _.hn(wva),
        rankBy: a => {
            if (a) throw _.Wm('unknown property "rankBy", did you mean "rankPreference"?');
        },
        rankPreference: _.hn(_.an(XE)),
        region: _.ct,
        maxResultCount: _.hn(_.Mfa),
        useStrictTypeFiltering: _.dt,
        evSearchOptions: _.hn(_.Ym({
            connectorTypes: _.hn(xva),
            minimumChargingRateKw: _.bt
        })),
        pureServiceAreaBusinessesIncluded: _.dt,
        futureOpeningBusinessesIncluded: a => {
            if (a !== void 0) throw _.Wm('unknown property "futureOpeningBusinessesIncluded"');
        }
    }),
    lta = _.Ym({
        fields: gta,
        locationRestriction: function(a) {
            try {
                const b = _.ls(a);
                if (b instanceof _.Np) return b
            } catch (b) {}
            throw _.Wm(`Invalid LocationRestriction: ${JSON.stringify(a)}`);
        },
        includedPrimaryTypes: _.hn(uE),
        includedTypes: _.hn(uE),
        excludedPrimaryTypes: _.hn(uE),
        excludedTypes: _.hn(uE),
        language: _.ct,
        maxResultCount: _.hn(_.Mfa),
        rankPreference: _.hn(_.an(YE)),
        region: _.ct,
        pureServiceAreaBusinessesIncluded: _.dt,
        futureOpeningBusinessesIncluded: a => {
            if (a !== void 0) throw _.Wm('unknown property "futureOpeningBusinessesIncluded"');
    ...
    vE = class extends TE {
        constructor(a) {
            ...
            if (a.id && a.resourceName) {
                if (this.id = this.Jh("id", _.et, a.id), this.resourceName = this.Jh("resourceName", _.et, a.resourceName), this.id !== _.ns(this.resourceName)) throw _.Wm("Place: `id` and `resourceName` must match or only one must be provided");
            } else if (a.id) this.id = this.Jh("id", _.et, a.id), this.resourceName = `places/${this.id}`;
            else if (a.resourceName) this.resourceName = this.Jh("resourceName", _.et, a.resourceName), this.id =
                _.ns(this.resourceName);
            else throw _.Wm("Place: `id` or `resourceName` must be set");
            this.requestedLanguage = this.Jh("requestedLanguage", _.ct, a.requestedLanguage);
            this.requestedRegion = this.Jh("requestedRegion", _.ct, a.requestedRegion);
...
vE.prototype.constructor = vE.prototype.constructor;
var wta = new Set(uF);
var SF = class extends $E {
    ...
    set place(a) {
        a = this.Jh("place", b => _.hn(_.fn([_.$m(vE, "Place"), _.$r]))(b), a);
        this.nh = a === void 0 ? null : typeof a === "string" ? new vE({
            id: _.ns(a)
        }) : a
    }
    constructor(a = {}) {
        ...
        this.nh = null;
        this.place = a.place;
        this.zi(a, SF, "PlaceDetailsPlaceRequestElement")
    }
    mh() {
        return this.place ? {
            place: this.place
...
_.A([_.tr({
    ...
    Kh: !0
}), _.B("design:type", Object), _.B("design:paramtypes", [Object])], SF.prototype, "place", null);
_.zp("gmp-place-details-place-request", SF);
var yva = new Set("accessibilityOptions allowsDogs hasCurbsidePickup hasDelivery hasDineIn hasLiveMusic hasMenuForChildren hasOutdoorSeating hasRestroom hasTakeout isGoodForChildren isGoodForGroups isGoodForWatchingSports isReservable parkingOptions paymentOptions servesBeer servesBreakfast servesBrunch servesCocktails servesCoffee servesDessert servesDinner servesLunch servesVegetarianFood servesWine".split(" "));
var xta = {
...
var Jta = new Set(["location", "viewport"]),
    zva = [],
    TF = class extends QF {
        static get Wm() {
            return { ...QF.Wm,
        ...
        get place() {
            if (this.Ak != null && this.Ak instanceof vE) return zE(this.Ak)
        }
        constructor(a = {}) {
            super(a);
            this.eu = new aF(this);
            this.Ux = new Set([lE, mE, nE, SF, RF, ...zva]);
            this.ek = {};
            this.photoDisplayDataList = [];
            this.Tr = "LOADING";
            this.Dh = {
        ...
        Oj(a) {
            ...
            if (a.has("ek")) {
                ...
                a && b ? kE(b, this.rh) ? this.Fh && this.Ak && !zta(this.Ak, a) && Gta(this, this.Ak) : (this.rh = b, b ? .place instanceof vE ? zta(b.place, a) ? Dta(this, b.place) : Gta(this, b.place) : b ? .location instanceof _.Rp && Ita(this, b.location)) : (this.rh = null, AE(this), _.Gr(this))
            }
        }
        mh() {
            return 1
    ...
    `
        ...
        Nu(a) {
            ...
            Object.assign(this.Dh, { ...a
            });
            JSON.stringify(Object.entries(b).sort((c, d) => c[0] < d[0] ? -1 : 1)) !== JSON.stringify(Object.entries(this.Dh).sort((c, d) => c[0] < d[0] ? -1 : 1)) && _.dq(this, "internalOptions", b)
        }
        Ph() {
            return 1
        }
        tv(a) {
            const b = zsa(this, a);
            b || _.lq(this, "Missing a content element. The Place Details widget requires both a content element (<gmp-place-content-config>, <gmp-place-standard-content>, or <gmp-place-all-content>) and a request element (<gmp-place-details-place-request> or <gmp-place-details-location-request>).");
            for (const {
                    Jv: c,
                    data: d
                } of a) switch (c) {
                case SF:
                    ...
                    _.lq(this, "Ignoring <gmp-place-details-place-request> with no place.");
                    break;
                case RF:
                    ...
                    _.lq(this, "Ignoring <gmp-place-details-location-request> with no location.")
            }
            return {
                content: b
            }
...
var Cva = {
    ...
    Eva = new Set([...PF.mh, ...eE.mh, "photos"]),
    Fva = new Set("displayName formattedAddress googleMapsLinks googleMapsURI rating shortFormattedAddress types userRatingCount".split(" ")),
    UF = class extends TF {
        get xh() {
            return _.Mq[35] ? Fva : new Set([...Eva])
        }
        constructor(a = {}) {
            super(a);
            this.Gh = Cva;
            ...
            this.zi(a, UF, "PlaceDetailsCompactElement")
        }
        Ah() {
            return "medium"
        }
        wh() {
            return new UE(this.mh())
        }
        mh() {
            return _.Mq[35] ? 9 : super.mh()
        }
        get truncationPreferred() {
            return this.oh
        }
        set truncationPreferred(a) {
            this.oh = this.Jh("truncationPreferred", _.dt, a) || !1
        }
        get orientation() {
            return this.th
        }
        set orientation(a) {
            this.th =
                this.Jh("orientation", b => _.hn(_.an(OF))(b) ? ? "VERTICAL", a)
        }
        Xr() {
            return Rta(this) ? ? (0, _.Q)
            ``
        }
        Rw() {
            return (0, _.Q)
      ...
      >${Rta(this)}`
        ...
        Sw() {
            if (this.orientation === "HORIZONTAL") {
                var a = FE(this, !0);
                a = (0, _.Q)
                `${a}${Nta(this.contentConfig,EE(this))}`
            } else a = [FE(this), Nta(this.contentConfig, EE(this))], a = (0, _.Q)
            `${SD(a)}`;
            return a
        }
        Ju() {
            if (!this.Ak || !this.contentConfig) return this.Xr();
            var a = this.Ak;
            switch (this.orientation) {
                case "HORIZONTAL":
                    const b = {
                        wC: _.Mq[171] && this.experimentalHideOpenInMapsButton ? "none" : "condensed",
                        ratingVariant: "single-star",
                        ratingInfoButtonShown: _.Mq[35] ? ? !1,
                        contentConfig: this.contentConfig,
                        tB: EE(this),
                        truncationPreferred: this.oh,
                        UC: this.Dh.showsRoutingSummary && this.Iw ? .UC || void 0,
                        yL: this.Dh.showsAttributeTags,
                        titleSize: this.Ah(),
                        infoButtonTapAreaExpanded: !1,
        ...
        ${FE(this,!0)??_.Pt}
        ${DE(a,b)}
        ${Mta(a,{variant:_.Mq[171]&&this.experimentalHideOpenInMapsButton?"none":"minimal"})}
        ${this.Dh.showsButtons?(0,_.Q)`<section class="button-section">
              ${Kta(a.googleMapsURI??null,"",{VN:this.Dh.WN})}
            </section>`:""}
      `
                    ];
                    break;
...
UF.prototype.constructor = UF.prototype.constructor;
UF.styles = [Ava];
UF.Hi = {
    Ki: 253439,
    Ji: 253419
...
_.A([_.tr({
    ...
    type: Boolean,
    Kh: !0
}), _.B("design:type", Object), _.B("design:paramtypes", [Object])], UF.prototype, "truncationPreferred", null);
_.A([_.tr({
    ii: _.yp(OF),
    Kh: !0
}), _.B("design:type", Object), _.B("design:paramtypes", [Object])], UF.prototype, "orientation", null);
_.zp("gmp-place-details-compact", UF);
var Gva = _.Xt([":host .outer-container{--gmp-mat-color-on-secondary-container:light-dark(#014f5a,#9fefff);--gmp-mat-color-on-surface:light-dark(#1f1f1f,#e3e3e3);--gmp-mat-color-on-surface-variant:light-dark(#5e5e5e,#ababab);--gmp-mat-color-outline-decorative:transparent;--gmp-mat-color-secondary-container:light-dark(#d3f7ff,#00363e);--gmp-mat-color-surface:light-dark(#fff,#131314);--gmp-mat-font-family:Google Sans Text,sans-serif;--gmp-mat-font-body-small:normal 400 0.75em/1.3333333333 var(--gmp-mat-font-family);--gmp-mat-font-label-large:normal 500 0.875em/1.4285714286 var(--gmp-mat-font-family);--gmp-mat-font-title-small:normal 500 0.875em/1.4285714286 var(--gmp-mat-font-family);--gmp-mat-font-body-medium:normal 400 0.875em/1.4285714286 var(--gmp-mat-font-family);--gmp-mat-spacing-small:0}:host .outer-container :host([orientation=horizontal i]){padding-bottom:8px}:host([orientation=vertical i]) .container .basic-info gmp-internal-link-button{margin-top:12px;padding-bottom:0;padding-top:0}:host([orientation=vertical i]) .outer-container{container-type:normal}section.basic-info{padding:0}"]);
var VF = !1,
    WF = class extends UF {
        get xh() {
        ...
        constructor(a = {}) {
            super(a);
            this.iG = !0;
            if (!VF) throw Error("InternalUsePlaceDetailsCompactElement is not allowed to be instantiated directly.");
        }
        get place() {
...
var Iva = {
    ...
    XF = class extends TF {
        constructor(a = {}) {
            super(a);
            this.xh = new Set([...PF.mh, ...eE.mh, ...yva, "addressComponents", "consumerAlert", "editorialSummary", "evChargeOptions", "formattedAddress", "fuelOptions",
            ...
            this.zi(a, XF, "PlaceDetailsElement")
        }
        wh() {
            return new UE(this.mh())
        }
        ...
        set orientation(a) {
            this.oh = this.Jh("orientation", b => _.hn(_.an(OF))(b) ? ? "VERTICAL", a)
        }
        Xr() {
            return SD([GE(this), (0, _.Q)
        ...
        Sw() {
            const a = this.contentConfig ? .media ? Wta(this) : "";
            return SD([GE(this), (0, _.Q)
                `<div class="spinner-container">
    ...
    `: _.Pt;
                ...
                const c = Uta({
                    ...
                    d = RD(b) && c.length > 1;
                a = (0, _.Q)
                ` ${DE(a,{addressEnabled:!1,contentConfig:this.contentConfig,tB:!0,wC:_.Mq[171]&&this.experimentalHideOpenInMapsButton?"none":"expanded",titleSize:"display-small",fontSize:"medium",slottedElements:this.jx})}
    ${Wta(this)??""}${b}
    ${c.length&&!d?(0,_.Q)`<hr />`:""}
    ${Vta(c)??""}`;
                a = (0, _.Q)
...
_.A([_.tr({
    ii: _.yp(OF),
    Kh: !0
}), _.B("design:type", Object), _.B("design:paramtypes", [Object])], XF.prototype, "orientation", null);
_.zp("gmp-place-details", XF);
var YF = class extends _.ku {
    constructor() {
        super(...arguments);
        this.numCards = 0;
        this.selectable = !1;
    ...
    oi() {
        ...
        for (let b = 0; b < this.numCards; b++) a.push((0, _.Q)
            `<div
          class="carousel-card"
          role=${this.selectable?"listitem":_.Pt}
        ...
        <div
          ...
          role=${this.selectable?"list":_.Pt}>
          ${a}
        </div>
    ...
    async sh() {
        this.oq && (await LE(this), KE(this), this.oq.addEventListener("scroll", this.ph.bind(this)), this.mh = new MutationObserver(() => {
            cua(this)
        }), bua(this), this.hn.forEach(a => {
...
var ME = !1,
    NE = class extends UF {
        constructor(a = {}) {
            super(a);
            this.qh = 1;
            if (!ME) throw Error("PlaceSearchListItemElement is not allowed to be instantiated directly.");
        }
        Oj() {}
        Ah() {
            return "title-medium"
...
var aG = class extends $E {
    ...
    set rankPreference(a) {
        this.qh = this.Jh("rankPreference", _.hn(_.an(YE)), a) || null
    }
    get rankPreference() {
        return this.qh
    }
    ...
    constructor(a = {}) {
        ...
        this.zi(a, aG, "PlaceNearbySearchRequestElement")
    }
    mh() {
        return {
            excludedPrimaryTypes: this.excludedPrimaryTypes ||
                void 0,
...
_.A([_.tr({
    ...
    ii: _.At,
    Kh: !0
}), _.B("design:type", Object), _.B("design:paramtypes", [Object])], aG.prototype, "excludedPrimaryTypes", null);
_.A([_.tr({
    Ih: "excluded-types",
    type: Array,
    ii: _.At,
    Kh: !0
}), _.B("design:type", Object), _.B("design:paramtypes", [Object])], aG.prototype, "excludedTypes", null);
_.A([_.tr({
    Ih: "included-primary-types",
    type: Array,
    ii: _.At,
    Kh: !0
}), _.B("design:type", Object), _.B("design:paramtypes", [Object])], aG.prototype, "includedPrimaryTypes", null);
_.A([_.tr({
    Ih: "included-types",
    type: Array,
    ii: _.At,
    Kh: !0
}), _.B("design:type", Object), _.B("design:paramtypes", [Object])], aG.prototype, "includedTypes", null);
_.A([_.tr({
    Ih: "location-restriction",
    ii: _.vga,
    Kh: !0
}), _.B("design:type", Object), _.B("design:paramtypes", [Object])], aG.prototype, "locationRestriction", null);
_.A([_.tr({
    Ih: "max-result-count",
    type: Number,
    Kh: !0
}), _.B("design:type", Object), _.B("design:paramtypes", [Object])], aG.prototype, "maxResultCount", null);
_.A([_.tr({
    Ih: "rank-preference",
    ii: _.yp(YE),
    Kh: !0
}), _.B("design:type", Object), _.B("design:paramtypes", [Object])], aG.prototype, "rankPreference", null);
_.A([_.tr({
    Ih: "future-opening-businesses-included",
    type: Boolean,
    Kh: !0
}), _.B("design:type", Object), _.B("design:paramtypes", [Object])], aG.prototype, "futureOpeningBusinessesIncluded", null);
_.zp("gmp-place-nearby-search-request", aG);
var bG = class extends $E {
    set textQuery(a) {
        this.Gh = this.Jh("textQuery", _.hn(_.et), a) || null
    }
    get textQuery() {
        return this.Gh
    }
    set evConnectorTypes(a) {
        this.rh = (a = this.Jh("evConnectorTypes", _.hn(xva), a)) && a.length ? a : null
    }
    get evConnectorTypes() {
        return this.rh
    }
    set evMinimumChargingRateKw(a) {
        this.th = this.Jh("evMinimumChargingRateKw", _.hn(_.$s), a) || null
    }
    ...
    set includedType(a) {
        this.wh =
            this.Jh("includedType", _.hn(_.et), a) || null
    }
    get includedType() {
        return this.wh
    }
    set isOpenNow(a) {
        this.xh = this.Jh("isOpenNow", _.dt, a) ? ? null
    }
    get isOpenNow() {
        return this.xh
    }
    set locationBias(a) {
        if ((a = this.Jh("locationBias", _.hn(pta), a)) && this.locationRestriction) throw _.jq(this, "locationBias", "Cannot set both locationBias and locationRestriction.");
        this.nh = a || null
    }
    get locationBias() {
        return this.nh
    ...
    set locationRestriction(a) {
        if ((a = this.Jh("locationRestriction", _.hn(_.Ao), a)) && this.locationBias) throw _.jq(this,
    ...
    set priceLevels(a) {
        this.Fh = (a = this.Jh("priceLevels", _.hn(wva), a)) && a.length ? a : null
    }
    get priceLevels() {
        return this.Fh
    }
    set rankPreference(a) {
        this.qh =
            this.Jh("rankPreference", _.hn(_.an(XE)), a) || null
    }
    get rankPreference() {
        return this.qh
    }
    set useStrictTypeFiltering(a) {
        this.Hh = this.Jh("useStrictTypeFiltering", _.dt, a) ? ? null
    }
    ...
    constructor(a = {}) {
        ...
        this.zi(a, bG, "PlaceTextSearchRequestElement")
    }
    mh() {
        return {
...
bG.prototype.constructor = bG.prototype.constructor;
bG.Hi = {
    Ki: 263985,
    Ji: 264957
};
_.A([_.tr({
    Ih: "text-query",
    Kh: !0
}), _.B("design:type", Object), _.B("design:paramtypes", [Object])], bG.prototype, "textQuery", null);
_.A([_.tr({
    Ih: "ev-connector-types",
    type: Array,
    ii: Qqa(WE),
    Kh: !0
}), _.B("design:type", Object), _.B("design:paramtypes", [Object])], bG.prototype, "evConnectorTypes", null);
_.A([_.tr({
    Ih: "ev-minimum-charging-rate-kw",
    type: Number,
    Kh: !0
}), _.B("design:type", Object), _.B("design:paramtypes", [Object])], bG.prototype, "evMinimumChargingRateKw", null);
_.A([_.tr({
    Ih: "future-opening-businesses-included",
    type: Boolean,
    Kh: !0
}), _.B("design:type", Object), _.B("design:paramtypes", [Object])], bG.prototype, "futureOpeningBusinessesIncluded", null);
_.A([_.tr({
    Ih: "included-type",
    Kh: !0
}), _.B("design:type", Object), _.B("design:paramtypes", [Object])], bG.prototype, "includedType", null);
_.A([_.tr({
    Ih: "is-open-now",
    type: Boolean,
    Kh: !0
}), _.B("design:type", Object), _.B("design:paramtypes", [Object])], bG.prototype, "isOpenNow", null);
_.A([_.tr({
    Ih: "location-bias",
    ii: {
        rk: a => a === "IP_BIAS" ? a : _.Ct.rk(a),
        Nj: a => typeof a === "string" ? a : _.Ct.Nj(a)
    },
    Kh: !0
}), _.B("design:type", Object), _.B("design:paramtypes", [Object])], bG.prototype, "locationBias", null);
_.A([_.tr({
    Ih: "location-restriction",
    ii: _.Ct,
    Kh: !0
}), _.B("design:type", Object), _.B("design:paramtypes", [Object])], bG.prototype, "locationRestriction", null);
_.A([_.tr({
    Ih: "max-result-count",
    type: Number,
    Kh: !0
}), _.B("design:type", Object), _.B("design:paramtypes", [Object])], bG.prototype, "maxResultCount", null);
_.A([_.tr({
    Ih: "min-rating",
    type: Number,
    Kh: !0
}), _.B("design:type", Object), _.B("design:paramtypes", [Object])], bG.prototype, "minRating", null);
_.A([_.tr({
    Ih: "price-levels",
    type: Array,
    ii: Qqa(VE),
    Kh: !0
}), _.B("design:type", Object), _.B("design:paramtypes", [Object])], bG.prototype, "priceLevels", null);
_.A([_.tr({
    Ih: "rank-preference",
    ii: _.yp(XE),
    Kh: !0
}), _.B("design:type", Object), _.B("design:paramtypes", [Object])], bG.prototype, "rankPreference", null);
_.A([_.tr({
    Ih: "use-strict-type-filtering",
    type: Boolean,
    Kh: !0
}), _.B("design:type", Object), _.B("design:paramtypes", [Object])], bG.prototype, "useStrictTypeFiltering", null);
_.zp("gmp-place-text-search-request", bG);
...
var Mva = new Set([...Eva, ...Jta]),
    cG = class extends QF {
        constructor(a = {}) {
            ...
            this.nh = new UE(2);
            this.eu = new aF(this);
            this.Ux = new Set([lE, mE, nE, bG, aG]);
            this.ek = {};
            this.mh = null;
            this.zi(a, cG, "PlaceSearchElement");
        ...
        set attributionPosition(a) {
            this.rh =
                this.Jh("attributionPosition", _.hn(_.an($F)), a) ? ? "TOP"
        }
        get attributionPosition() {
            return this.rh
        }
        set selectable(a) {
            this.KB = this.Jh("selectable", _.dt, a) ? ? !1
        }
        get selectable() {
            return this.KB
        }
        set truncationPreferred(a) {
            this.qh = this.Jh("truncationPreferred", _.dt, a) || !1
        }
        get truncationPreferred() {
            return this.qh
        }
        set orientation(a) {
            this.oh = this.Jh("orientation", _.hn(_.an(ZF)), a) ? ? "VERTICAL"
        }
        get orientation() {
            return this.oh
        }
        get places() {
            return this.qq ? this.qq.map(({
                place: a
            }) => zE(a)) : []
        }
        tv(a) {
            const b = zsa(this,
                a);
            b || _.lq(this, "Missing a content element. The Place Search widget requires both a content element (<gmp-place-content-config>, <gmp-place-standard-content>, or <gmp-place-all-content>) and a request element (<gmp-place-text-search-request> or <gmp-place-nearby-search-request>).");
            for (const {
                    Jv: c,
                    data: d
                } of a) switch (c) {
                case bG:
                    ...
                    _.lq(this, "Ignoring <gmp-place-text-search-request> with no text query.");
                    break;
                case aG:
                    a = d;
                    ...
                    _.lq(this, "Ignoring <gmp-place-nearby-search-request> with no location restriction.")
            }
            return {
                content: b
            }
        ...
        Ju() {
            if (!this.ek ? .content) return this.Xr();
            const a = this.qq ? ? [];
            return a.length === 0 ? OE((0, _.Q)
    ...
    `
        ...
        Oj(a) {
            super.Oj(a);
            a.has("ek") && ((a = this.ek.request, this.ek.content && a) ? kE(a, this.mh) || (this.mh = a, a.textQuery !== void 0 ? this.pG({
            ...
            }) : a.locationRestriction !== void 0 && a.textQuery === void 0 && this.qG(a)) : (this.mh = null, this.qq = void 0, _.Gr(this)))
        }
        async pG(a) {
            const b = kta({ ...a,
                fields: Array.from(Mva)
            });
            await _.Hr(this, async c => {
                const d = c(await this.nh.fetch(c)).fo(),
                    e = c(await qta(b, {
                        lm: d
                    }));
                this.qq = mua(e.places);
                this.Dk = 2;
                this.qq = c(await eua(e.places, {
                    lm: d
                }, c))
            }, 230162)
        }
...
cG.prototype.loadFromSearchNearbyRequestInternal = cG.prototype.qG;
cG.prototype.loadFromSearchByTextRequestInternal = cG.prototype.pG;
...
_.A([_.Aea({
    context: kF
}), _.B("design:type", Object)], cG.prototype, "KB", void 0);
_.A([_.vr(), _.B("design:type", Array)], cG.prototype, "qq", void 0);
_.A([_.tr({
    Ih: "attribution-position",
    ii: _.yp($F),
    Kh: !0
}), _.B("design:type", Object), _.B("design:paramtypes", [Object])], cG.prototype, "attributionPosition", null);
_.A([_.tr({
    type: Boolean,
    Kh: !0
}), _.B("design:type", Object), _.B("design:paramtypes", [Object])], cG.prototype, "selectable", null);
_.A([_.tr({
    Ih: "truncation-preferred",
    type: Boolean,
    Kh: !0
}), _.B("design:type", Object), _.B("design:paramtypes", [Object])], cG.prototype, "truncationPreferred", null);
_.A([_.tr({
    ii: _.yp(ZF),
    Kh: !0
}), _.B("design:type", Object), _.B("design:paramtypes", [Object])], cG.prototype, "orientation", null);
_.A([_.vr({
    ij: (a, b) => !kE(a, b)
}), _.B("design:type", Object)], cG.prototype, "ek", void 0);
_.zp("gmp-place-search", cG);
var QE = class {
    ...
    get placePrediction() {
        if (this.mh.ph()) {
            var a = this.mh.nh();
            a = new dG(a, this.JC, this.RB, this.YC, this.xC)
        } else a = null;
        return a
    }
};
QE.fetchAutocompleteSuggestions = oua;
var dG = class {
    constructor(a, b, c, d, e) {
        this.Ur = a;
        this.JC = b;
    ...
    get text() {
        return SE(this.Ur.di() ? ? null)
    }
    get mainText() {
        return this.Ur.nh() ? .qh() ? SE(this.Ur.nh().nh()) : null
    }
    get secondaryText() {
        return this.Ur.nh() ? .rh() ? SE(this.Ur.nh().ph()) : null
    }
    get types() {
        return this.Ur ? .rh() ? ? []
    }
    get distanceMeters() {
        return this.xC == null || this.types.includes("route") ? null : this.Ur ? .ph()
    }
    toPlace() {
        const a = new vE({
            id: this.placeId,
            requestedLanguage: this.RB,
            requestedRegion: this.JC
        });
        a.zo(this.YC);
        return a
    }
...
dG.prototype.fetchAddressValidation = dG.prototype.fetchAddressValidation;
dG.prototype.toPlace = dG.prototype.toPlace;
var Nva = class {
        constructor(a) {
            this.mh = a
        }
    ...
    RE = class {
        ...
        get matches() {
            return this.mh ? .nh().map(a => new Nva(a)) ? ? []
        }
        toString() {
            return this.text
        }
...
var Pva = _.ks("api-3/images/autocomplete-icons", !0, !1),
    ...
    eG = class extends ZE {
        ...
        constructor(a) {
            ...
            document.createElement("img").src = Pva;
            this.xi = rua()
        }
        sh() {
            super.sh();
            this.Bk ? .append(this.xi)
        }
        get includedRegionCodes() {
            return this.Fj
        }
        set includedRegionCodes(a) {
            this.Fj = this.Jh("includedRegionCodes",
                Qva, a) ? ? null
        }
        get includedPrimaryTypes() {
            return this.Bj
        ...
        set includedPrimaryTypes(a) {
            this.Bj = this.Jh("includedPrimaryTypes", Qva, a) ? ? null
        }
        get origin() {
            return this.xh
        }
        set origin(a) {
            this.xh = (a = this.Jh("origin", _.hn(_.Ir), a)) ? new _.Rp(a) : null
        }
        get unitSystem() {
            return this.Ti
        }
        set unitSystem(a) {
            this.Ti = this.Jh("unitSystem", _.hn(_.an(_.Er)), a) ? ? null
        }
        ...
        set requestedLanguage(a) {
            this.Li =
                this.Jh("requestedLanguage", _.ct, a) ? ? null;
            sua(this)
        }
        get locationBias() {
            return this.oj
        ...
        set locationBias(a) {
            a = this.Jh("locationBias", _.hn(_.ls), a) ? ? null;
        ...
        set locationRestriction(a) {
            a = this.Jh("locationRestriction", _.hn(_.ms), a) ? ? null;
        ...
        set requestedRegion(a) {
            this.Oi = this.Jh("requestedRegion",
                _.ct, a) ? ? null;
            sua(this)
        }
        get types() {
        ...
        set pureServiceAreaBusinessesIncluded(a) {
            this.Pj = this.Jh("pureServiceAreaBusinessesIncluded", _.dt, a) ? ? null
        }
    };
...
eG.styles = [Ova, ZE.styles];
_.A([_.tr({
    Ih: "included-region-codes",
    ii: _.At,
    Kh: !0
}), _.B("design:type", Object), _.B("design:paramtypes", [Object])], eG.prototype, "includedRegionCodes", null);
_.A([_.tr({
    Ih: "included-primary-types",
    ii: _.At,
    Kh: !0
}), _.B("design:type", Object), _.B("design:paramtypes", [Object])], eG.prototype, "includedPrimaryTypes", null);
_.A([_.tr({
    ii: _.Dt,
    Kh: !0
}), _.B("design:type", Object), _.B("design:paramtypes", [Object])], eG.prototype, "origin", null);
_.A([_.tr({
    Ih: "unit-system",
    ii: _.yp({
        METRIC: 0,
    ...
    Kh: !0
}), _.B("design:type", Object), _.B("design:paramtypes", [Object])], eG.prototype, "unitSystem", null);
_.A([_.tr({
    Ih: "requested-language",
    type: String,
    Kh: !0
}), _.B("design:type", Object), _.B("design:paramtypes", [Object])], eG.prototype, "requestedLanguage", null);
_.A([_.tr({
    Ih: "requested-region",
    type: String,
    Kh: !0
}), _.B("design:type", Object), _.B("design:paramtypes", [Object])], eG.prototype, "requestedRegion", null);
_.A([_.tr({
    ii: _.At,
    Kh: !0
}), _.B("design:type", Object), _.B("design:paramtypes", [Object])], eG.prototype, "types", null);
_.A([_.tr({
    Ih: "future-opening-businesses-included",
    type: Boolean,
    Kh: !0
}), _.B("design:type", Object), _.B("design:paramtypes", [Object])], eG.prototype, "futureOpeningBusinessesIncluded", null);
_.A([_.tr({
    Ih: "pure-service-area-businesses-included",
    type: Boolean,
    Kh: !0
}), _.B("design:type", Object), _.B("design:paramtypes", [Object])], eG.prototype, "pureServiceAreaBusinessesIncluded", null);
var fG = class extends eG {
    constructor(a) {
        super(a);
        this.Do = new UE(3);
        this.mi = this.rh = null;
        this.zi(a, fG, "BasicPlaceAutocompleteElement");
        _.Wl("util").then(b => {
            b.ur()
        })
    }
    async Dm(a) {
        ...
        b || await vua(this);
        if (this.rh == null || this.rh === "") throw Error("Could not fetch credentials.");
        return await nua(a, {
            lm: this.rh
        })
    }
...
var Rva = {
    ...
    gG = class extends $E {
        constructor(a = {}) {
            ...
            this.zi(a, gG, "PlaceContextualListConfigElement")
        }
        get layout() {
            return this.oh
        }
        set layout(a) {
            this.oh = this.Jh("layout", _.hn(_.an(Rva)), a && a.toUpperCase()) ? ? "VERTICAL"
        }
        get mapHidden() {
            return this.ph
        }
        set mapHidden(a) {
            this.ph = this.Jh("mapHidden",
                _.dt, a) ? ? !1
        }
        get mapMode() {
            return this.nh
        ...
        set mapMode(a) {
            ...
            this.nh = this.Jh("mapMode", _.hn(_.an(Sva)), a) ? ? "ROADMAP"
        }
        mh() {
            return {
                layout: this.layout,
...
var hG = class extends _.Ju {
    constructor(a = {}) {
        ...
        this.zi(a, hG, "PlaceContextualElement");
    ...
    tv(a) {
        return {
            list: a.find(b => b.Jv === gG) ? .data ? ? null
        }
    }
    qr(a) {
        super.qr(a);
        a.has("ek") && this.ek.list && (this.Py = this.ek.list.layout === "COMPACT", this.Qy = !this.ek.list.mapHidden, this.gE = this.ek.list.mapMode)
    }
};
hG.prototype.constructor = hG.prototype.constructor;
hG.Hi = {
    Ki: 239098,
    Ji: 239097
};
...
}), _.B("design:type", Object)], hG.prototype, "ek", void 0);
_.A([_.vr(), _.B("design:type", String)], hG.prototype, "WF", void 0);
_.A([_.vr(), _.B("design:type", Object)], hG.prototype, "Py", void 0);
_.A([_.vr(), _.B("design:type", Object)], hG.prototype, "Qy", void 0);
_.A([_.vr(), _.B("design:type", Object)], hG.prototype, "gE", void 0);
_.A([_.vr(), _.B("design:type", Object)], hG.prototype, "ZG", void 0);
_.A([_.ur(".compact-items"), _.B("design:type", Object)], hG.prototype, "AQ", void 0);
_.A([CD(".compact-items > gmp-internal-link-button"), _.B("design:type", Array)], hG.prototype, "BQ", void 0);
_.A([_.ur(".compact-menu gmp-internal-menu"), _.B("design:type", mF)], hG.prototype, "CQ", void 0);
_.A([CD(".list-item"), _.B("design:type", Array)], hG.prototype, "pR", void 0);
_.A([_.tr({
    Kh: !0,
    Ih: "context-token"
}), _.B("design:type", Object), _.B("design:paramtypes", [Object])], hG.prototype, "contextToken", null);
var Uva = class extends Event {
    constructor(a) {
        super("gmp-select", {
            bubbles: !0
        });
...
var iG = class extends eG {
    ...
    constructor(a) {
        super(a);
        this.sessionToken = new _.Nu;
        this.zi(a, iG, "PlaceAutocompleteElement");
...
iG.prototype.constructor = iG.prototype.constructor;
_.A([_.tr({
    type: String,
    Kh: !0
}), _.B("design:type", Object), _.B("design:paramtypes", [Object])], iG.prototype, "placeholder", null);
_.A([_.tr({
    type: String,
    Kh: !0
}), _.B("design:type", Object), _.B("design:paramtypes", [Object])], iG.prototype, "value", null);
var jG = {
    PlacesService: cF,
    PlacesServiceStatus: {
        OK: "OK",
    ...
    AutocompleteService: OD,
    AutocompleteSessionToken: _.Nu,
    Autocomplete: ND,
    BusinessStatus: {
    ...
    Place: vE,
    AccessibilityOptions: UD,
    AddressComponent: xra,
    Attribution: yra,
    OpeningHours: WD,
    OpeningHoursPeriod: Zua,
    OpeningHoursPoint: sF,
    SecondaryOpeningHours: XD,
    EvChargeAmenitySummary: VD,
    EVChargeAmenitySummary: VD,
    EVChargeOptions: Ara,
    EVConnectorType: WE,
    ConnectorAggregation: qF,
    FuelOptions: Bra,
    FuelType: {
        DIESEL: "DIESEL",
    ...
    FuelPrice: rF,
    GenerativeSummary: Dra,
    Money: _.Pu,
    NeighborhoodSummary: Cra,
    ParkingOptions: YD,
    PaymentOptions: ZD,
    Photo: $D,
    AuthorAttribution: tF,
    PlusCode: _.Qu,
    PostalAddress: _.Ru,
    Review: aE,
    ReviewSummary: Hra,
    ...
    GoogleMapsLinks: Era,
    ConsumerAlert: zra,
    ConsumerAlertDetails: nF,
    TimeZone: Ira,
    AddressDescriptor: Jra,
    PlaceSelectEvent: PE,
    SearchByTextRankBy: void 0,
    SearchByTextRankPreference: XE,
    SearchNearbyRankPreference: YE,
    AutocompleteSuggestion: QE,
    PlacePrediction: dG,
    FormattableText: RE,
    StringRange: Nva,
    PlaceAutocompleteElement: iG,
    PlacePredictionSelectEvent: Uva,
    BasicPlaceAutocompleteElement: fG,
    PlaceDetailsElement: XF,
    PlaceDetailsCompactElement: UF,
    PlaceDetailsOrientation: OF,
    PlaceDetailsLocationRequestElement: RF,
    PlaceDetailsPlaceRequestElement: SF,
    PlaceContentConfigElement: lE,
    PlaceStandardContentElement: mE,
    PlaceAllContentElement: nE,
    PlaceAccessibleEntranceIconElement: hF,
    PlaceAddressElement: iF,
    PlaceAttributionElement: NF,
    AttributionColor: fF,
    PlaceMediaElement: zF,
    MediaSize: eF,
    PlaceOpenNowStatusElement: AF,
    PlacePriceElement: EF,
    PlaceRatingElement: GF,
    PlaceTypeElement: KF,
    PlaceWebsiteElement: MF,
    PlacePhoneNumberElement: CF,
    PlaceOpeningHoursElement: BF,
    PlaceSummaryElement: JF,
    PlaceTypeSpecificHighlightsElement: LF,
    PlaceReviewSummaryElement: HF,
    PlaceReviewsElement: IF,
    PlacePlusCodeElement: DF,
    PlaceFeatureListElement: jF,
    PlaceSearchElement: cG,
    PlaceSearchAttributionPosition: $F,
    PlaceSearchOrientation: ZF,
    PlaceNearbySearchRequestElement: aG,
    PlaceTextSearchRequestElement: bG,
    ...
    connectForExplicitThirdPartyLoad: () => {
        _.zp("gmp-place-autocomplete", iG);
        _.zp("gmp-basic-place-autocomplete", fG);
        tsa()
    },
    PE: function(a = {}, b = {}) {
        VF = !0;
        a = new WF(a);
        a.Nu(b);
        a.appendChild(new SF);
        a.appendChild(new lE).appendChild(new iF);
        VF = !1;
        return a
    }
};
_.Nm(jG, ["connectForExplicitThirdPartyLoad", "PE"]);
_.Mm(jG);
_.ya.google.maps.places = { ...jG,
    RatingLevel: {
        GOOD: 0,
        VERY_GOOD: 1,
        EXCELLENT: 2,
