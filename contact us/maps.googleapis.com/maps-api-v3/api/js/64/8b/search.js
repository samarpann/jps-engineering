google.maps.__gjsload__('search', function(_) {
    var hya = function(a) {
        ...
        gya = function(a) {
            ...
            const d = [];
            a.Sv().forEach(e => {
                e.a && e.a.length >= 2 && d.push(new iya(e, b, c))
            });
            return d
        },
        jya = class extends _.fo {};
    var kya = {
            ["1"]: {}
        },
        iya = class {
            ...
            getAnchor() {
                if (!this.anchor) {
                    const a = 1 << this.zoom;
                    this.anchor = _.Mr(new _.ar((this.Bo.x * 256 + this.source.a[0]) / a, (this.Bo.y * 256 + this.source.a[1]) / a)).toJSON()
                }
                return this.anchor
            }
            getCompleteBounds() {
